...
<div class="row">
  ...
  <hr>
  <a  class="nav-link pl-2 " style="font-size:1.2rem; color:#A41FDE" href="visteurs.php?page=cpc&id=<?=$_SESSION['id'] ?>"> 
 ...
 <a style="font-size:1.2rem; " class="nav-link pl-2 " href="visteurs.php?page=banque&id=<?=$_SESSION['id'] ?>">
...
<a   class="nav-link pl-2 " style="font-size:1.2rem;" href="visteurs.php?page=capital&id=<?=$_SESSION['id'] ?>">
...
<a  class="nav-link pl-2 " style="font-size:1.2rem;" href="visteurs.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
...
<a class="nav-link pl-2 " style="font-size:1.2rem; "   href="visteurs.php?page=clients&id=<?=$_SESSION['id'] ?>">              
...
<a  class="nav-link pl-2" style="font-size:1.2rem; " href="visteurs.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
...
<a  class="nav-link pl-2 " style="font-size:1.3rem; "  href="visteurs.php?page=factures&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures
  ...
  <a  class="nav-link pl-2 "  style="font-size:1.2rem;" href="visteurs.php?page=produits&id=<?=$_SESSION['id'] ?>"> 
 ...
 <a  class="nav-link pl-2 "  style="font-size:1.2rem;" href="visteurs.php?page=charges&id=<?=$_SESSION['id'] ?>"> 
 ...
 Charges
   ...
   <a  class="nav-link pl-2 " style="font-size:1.2rem;" href="visteurs.php?page=Stocks&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
 </svg>
 Stocks
</a><hr>
<a  class="nav-link pl-2 "style="font-size:1.2rem;"  href="visteurs.php?page=balance&id=<?=$_SESSION['id'] ?>">
...
<a  class="nav-link pl-2" style="font-size:1.2rem;" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
...
<div class="col-lg-8 col-12  mt-5  ">    
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_produitdexploitation&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
   ...
   <?php
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_chargesdexploitation&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
          <?= $resultat['nom_operation'] ?>
          </div>
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_produitfinancier&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
          <?= $resultat['nom_operation'] ?>
          </div>
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_chargesfinanciere&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
          <?= $resultat['nom_operation'] ?>
          </div>
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_produits_exceptionnel&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
          <?= $resultat['nom_operation'] ?>
          </div>
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_chargesexceptionnelles&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
          <?= $resultat['nom_operation'] ?>
          </div>
