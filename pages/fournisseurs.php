...
<div class="row">
     ...
     <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul  class="navbar-nav  mr-auto ">
         ...
         <a style='font-size:1.1rem' class="nav-link text-white ml-5 bg-info " href="index.php?page=nouveau_fournisseur&id=<?=$_SESSION['id'] ?>">
         
         <p style='  font-size:1.2rem;'>Créer un nouveau compte</p>
   ...
   <div class="col-lg-9 mt-5 col-12">    
    <div class="col-lg-12">
   <div class="row">
     <?php
     ...
     while($resultat=$select->fetch())
        {
            ...
            <div class="col-2 ">
             ...
             <a class="nav-link text-center text-secondary " href="index.php?page=detail_fournisseurs&id=<?=$resultat['id'] ?>">
                <div class='imagess'>
