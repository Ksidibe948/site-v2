...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  ...
  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <hr>
  <a  class="nav-link " style="font-size:1.2rem;  color:#A41FDE " href="visteurs.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
  ...
  <a class="nav-link  text-info" style="font-size:1.2rem;"  href="visteurs.php?page=nouveau_fournisseur&id=<?=$_SESSION['id'] ?>">
  ...
  <a  class="nav-link " style="font-size:1.2rem;" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
   ...
   CPC
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a class="nav-link text-light" href="visteurs.php?page=nouveau_fournisseur&id=<?=$_SESSION['id'] ?>">
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ...
            <a class="nav-link " href="visteurs.php?page=detail_fournisseurs&id=<?= $resultat['id'] ?>">
