...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $select=$bdd->prepare('SELECT * FROM fournisseurs where id_entreprise=? ORDER BY id DESC');
...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  ...
  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <hr>
  <a  class="nav-link " style="font-size:1.2rem;  color:#A41FDE " href="index.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
  ...
  <a class="nav-link  text-info" style="font-size:1.2rem;"  href="index.php?page=nouveau_fournisseur&id=<?=$_SESSION['id'] ?>">
  ...
  <a  class="nav-link " style="font-size:1.2rem;" href="index.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
   ...
   CPC
    ...
    <div class="col-lg-12 mt-3 ">
        <div class="card  w-100 shadow-lg  bg-info"  >
        <div class="card-title text-center pt-5">
        <a class="nav-link text-light" href="index.php?page=nouveau_fournisseur&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Ajouter un Fournisseur</p>
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ...
            <a class="nav-link " href="index.php?page=detail_fournisseurs&id=<?= $resultat['id'] ?>">
             <div class="card w-100 shadow-lg  bg-white p-1 " >
               <div class="card-title text-center text-dark bg-light shadow-lg" style=" border-radius: 10px;">
               <h4><?= $resultat['nom'] ?></h4> 
               </div>
                <div class='imagess'>
