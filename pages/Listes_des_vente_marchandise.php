...
<div class="row">
   ...
   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    Factures de Ventes Marchandises
     ...
     <a style='font-size:1.3rem' class="nav-link p-3  mb-1 shadow-sm bg-light  text-info "  href="visteurs.php?page=Listes_des_vente_marchandise&id=<?=$_SESSION['id'] ?>">
  <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
  </svg>
     Liste des Marchandise Acheter
  </a>
   ...
   <div class="col-lg-6 col-11"> 
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a class="nav-link text-light"  href="visteurs.php?page=nouvellefacturevente_marchandise&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'> Vente de  Autre Marchandise Non enregistre </p>
               ...
               <?php 
                if ($resultat['quantiteS']>0) {
                  ?>
                   ...
                   <div class="card ml-4 w-100 shadow-lg  p-4 " >
                   <a class="nav-link ligh  text-secondary bg-light" href="visteurs.php?page=nouvellefacturevente_marchandise&id=<?=$resultat['id'] ?>">
