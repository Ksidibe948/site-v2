  ...
  <div class="row">
     ...
     <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      Factures Achats
       ...
       <a  class="nav-link pl-2 "  style="font-size:1.2rem;color:#A41FDE" href="index.php?page=achat_immobilisation&id=<?=$_SESSION['id'] ?>"> 
     ...
     <div class="row ">
      ...
      <div class="col-lg-4 ">
          ...
          <a  class="nav-link text-secondary bg-light"  href="index.php?page=AchatsImmobilisationsCorporelles&id=<?=$_SESSION['id'] ?>">              
      ...
      <div class="col-lg-4  ">
          <div class="card w-100  shadow-lg bg-lightpb-5  mb-2"  >
          <div class="card-title text-center ">
          <a  class="nav-link text-secondary bg-light" href="index.php?page=AchatsImmobilisationsIncorporelles&id=<?=$_SESSION['id'] ?>"> 
      ...
      <div class="col-lg-4  ">
          <div class="card w-100  shadow-lg bg-lightpb-5  mb-2"  >
          <div class="card-title text-center ">
          <a  class="nav-link text-secondary bg-light"  href="index.php?page=AchatsImmobilisationsFinancières&id=<?=$_SESSION['id'] ?>"> 
