 ...
 
{
  ...
  if ($_FILES['monfichier']['size'] <= 1000000)
  {
          ...
          if (in_array($extension_upload, $extensions_autorisees))
          {
                 ...
                 $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
                 $inser=$bdd->prepare('INSERT INTO publications(id_utilisateurs,contenu,fichier)VALUES(?,?,?)');
                 $inser->execute(array($_SESSION['id'],$contenu,$image));
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
     <div class="row">
       ...
       <textarea name="editor1" value=""></textarea>
       </div>
       <div class="col-lg-12 ">
       <input type="file"  name='monfichier'class="form-control mr-5" id="inputCity" >
       </div> 
       <div class="col-lg-12 mt-1 ">
       <input style='text-decoration: none;color:#A41FDE' type="submit"  value="Valider">
       </div> 
       </div> 
      </form>
   </div>
