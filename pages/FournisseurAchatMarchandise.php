...
<?php
   ...
   FROM AchatsImmoCorporelle,fournisseurs WHERE AchatsImmoCorporelle.id_client=fournisseurs.id AND AchatsImmoCorporelle. id_client=? ORDER BY id DESC");
...
<div class="row">
 ...
 <?php
  ...
  <h5> vous n'avez pas encore payé une marchandise chez <?=$resultat['nom']?></h5>
