 ...
 Charges Activés
   ...
   <div class="row ">
    <div class="col-lg-12 mt-3 ">
        ...
        <a  class="nav-link text-white"    href="index.php?page=nouveauchargesActive&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>  Activé une charge</p>
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          ...
          <h1>La liste des Charges Activés </h1>
        </div>
          </div>
   <div class="row ">
