...
<?php
   ...
   $select_produitsexceptionnel=$bdd->prepare('SELECT id,id_entreprise,nom_operation,montant_th, 
    ...
    FROM chargeACtive where id_entreprise=?  ORDER BY id DESC');
...
<div class="row">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark " href="visteurs.php?page=detail_chargesActivation&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
          <div class="col-4 pt-2 text-left"style='border:solid 0.5px gray'>
             <?= $resultat['date'] ?>
          </div>
