...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ol class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="index.php?page=comptabilite"> Comptabilités <span class="sr-only">(current)</span></a>
            
            <li class="nav-item active  mr-3">
              <a class="nav-link" href="">Charges<span class="sr-only">(current)</span></a>
            
            <li class="nav-item mr-3">
            <a class="nav-link" href="index.php?page=banque">banque
                </a>
  ...
  <div class="container ">
    <h1 class="display-4 text-center">Charges</h1>
    <li class="lead text-center">Bienvenue sur la page des Charges    <strong> <?= $_SESSION['nom'] ?></strong> !
  </div>
   </div>
      <div class="row ">
      <div class="col-lg-4"></div>
        <div class="col-lg-5 ">
         <div class="card w-100 shadow-lg mb-2">
          <div class="card-title pl-5">
            <div class="card-body">
           <ol>
            <div class="row ">
           
            <div class="col-lg-12 mb-2 ">
            <h5><a href=""><a href="index.php?page=achats&id=<?=$_SESSION['id'] ?>"><li>Achats des Marchandises</li> </a></h5>
            </div>
            <div class="col-lg-12 mb-2 ">
            <h5><a href=""><a href="index.php?page=achat_immobilisation&id=<?=$_SESSION['id'] ?>"><li>Achats des Materièls</li> </a></h5>    
            </div>
            <div class="col-lg-12 ">
             <h5><a href="index.php?page=autres_charges&id=<?=$_SESSION['id'] ?>"><li>Autres Sorties  d'argents</li> </a></h5>
            </div>
            </div>
            </ol>
            </div>
