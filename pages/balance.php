    ...
    <div class="banner-area">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ol class="navbar-nav mr-auto">
            ...
            <li class="nav-item mr-3">
            <a class="nav-link" href="visteurs.php?page=banque">banque
                </a>
         ...
         <div class="card w-100 shadow-lg mb-2">
          <div class="card-title pl-5">
           ...
           <ol>
            ...
            <h5><a href=""><a href="visteurs.php?page=achats&id=<?=$_SESSION['id'] ?>"><li>Achats des Marchandises</li> </a></h5>
            </div>
            <div class="col-lg-12 mb-2 ">
            <h5><a href=""><a href="visteurs.php?page=achat_immobilisation&id=<?=$_SESSION['id'] ?>"><li>Achats des Materièls</li> </a></h5>    
            </div>
            <div class="col-lg-12 ">
             <h5><a href="visteurs.php?page=autres_charges&id=<?=$_SESSION['id'] ?>"><li>Autres Sorties  d'argents</li> </a></h5>
            </div>
            </div>
            </ol>
            </div>
