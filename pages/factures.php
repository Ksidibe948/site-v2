...
<div class="row">
     ...
     <a  class="nav-link p-3  mb-1 shadow-sm bg-light bg-light bg-light " style="font-size:1.3rem;color:#A41FDE "  href="index.php?page=factures&id=<?=$_SESSION['id'] ?>">              
   ...
   <div class="row ">
    <div class="col-lg-6 ">
        ...
        <a  class="nav-link text-secondary bg-light"  href="index.php?page=facturesachats&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-6  ">
        ...
        <a  class="nav-link text-secondary bg-light" href="index.php?page=facturesventes&id=<?=$_SESSION['id'] ?>"> 
