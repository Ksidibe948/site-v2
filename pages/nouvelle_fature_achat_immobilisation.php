...
<?php
 ...
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        $stokks_marchandises=$bdd->prepare('INSERT INTO stoks_materiels
      ...
      $insert=$bdd->prepare('INSERT INTO achats_immobilisation
      (
        id_client,
        id_entreprise,
        marchandise,
    ...
    header('Location:index.php?page=achat_immobilisation&id='.$_SESSION['id']);
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures
  ...
  <a  class="nav-link  " style="font-size:1.1.2rem; "  href="index.php?page=facturesachats&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
...
<a  class="nav-link  " style="font-size:1.1.2rem;   "  href="index.php?page=achats&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures Achats de Materiels <span style='color:green'>( <?= $stok_materiel?>)</span> 
  ...
  <a style='font-size:1.2rem ;color:#A41FDE' class="nav-link  "  href="#">
...
<?php
      if ($stok_marchandise>0) {
        ?>
       <a  class="nav-link   " style="font-size:1.2rem;"href="index.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>"> 
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
       </svg>
 ...
 <?php
      if ($stok_materiel>0) {
        ?>
        <a  class="nav-link  " style="font-size:1.2rem;" href="index.php?page=stocks_materiels&id=<?=$_SESSION['id'] ?>"> 
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
    </svg>
 ...
 CPC
     ...
     <div class="container">
        <div class="col-lg-8">
                            ...
                            <div class="col-lg-12">
                            <div class="card shadow-lg bg-light w-100" style="width: 18rem; ">
                            <div class="card-body">
                              ...
                              <label for="inputPassword" class="col-sm-2 col-form-label"> Fournisseur   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-2 col-form-label">Materièl   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-sm-3 col-form-label">Taux   </label>
                              <div class="col-sm-3">
                              ...
                              <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">Exompte   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">Transport   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">TVA   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">Emballage   </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">Banque </label>
                              <div class="col-sm-3">
                            ...
                            <?php
                              ...
                              <div class="form-group row">
                              <label for="inputPassword" class="col-sm-4 col-form-label">Montant payer :  </label>
                              <div class="col-sm-3">
...
<div class="alert alert-warning alert-dilgissible fade show text-center" role="alert">
  <strong>Amortissement !  </strong>Ces informations sont utilisées pour calculer l'amortissement du materiel. Elle sont obligatoires!
</div>     
</div><hr>
...
<label for="inputPassword" class="col-lg-4 col-form-label ml-1">Mois de mis en service:</label>
 ...
 <div class="form-group row">
<label for="inputPassword" class="col-lg-4 col-form-label"> Système</label>
<div class="col-lg-3">
<select id="inputState" name="systeme" class="form-control mr-5">
 ...
 <div class="form-group row">
<label for="inputPassword" class="col-lg-4 col-form-label">Durées de vie:</label>
<div class="col-lg-3">
