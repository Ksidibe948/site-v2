...
<div class="row">
   ...
   <div class="row ">
    <div class="col-lg-12 mt-3 ">
        ...
        <a  class="nav-link text-white"    href="index.php?page=nouveauproduit_exceptionnel&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Enregistre un nouveau produit non courant</p>
