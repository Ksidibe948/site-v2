...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $select_produitsexceptionnel=$bdd->prepare('SELECT id,id_entreprise,nom_operation,montant_th,taux_tva, montant_payer,
            ...
            <div class="row ml-2 mr-2 ">
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-4 text-right"style='border:solid black 0.5px'>
                    <h6> TVA Facturé sur l'Operation <?= $resultat['nom_operation'] ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
