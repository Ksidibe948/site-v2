...
if ($_GET['id']) {
    $getid=$_GET['id'];
    $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
    $select=$bdd->prepare("SELECT id, id_entreprise,nom_banque,adresse,numero,email,photo,montant,frais, taux_tva,DATE_FORMAT(date,'%d/%m/%Y à %Hh%imin%ss') AS date FROM banque WHERE id=? ORDER BY id DESC");
    $select->execute(array($_GET['id']));
    $donness=$select->fetch();
     $donness['id'];
    $montant_tva=$donness['frais']*$donness['taux_tva']/100;
    $commission_bancaire=$donness['frais']+$montant_tva;
    $montant_ala_banque=$donness['montant']- $commission_bancaire;
}
...
<div class="row">
   ...
   <a style='margin-left:15px ;' class="nav-link p-3  mb-1 shadow-sm bg-light text-success " href="visteurs.php?page=modifier_banque&id=<?=$donness['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
  </svg> Modifier  <?=$donness['nom_banque'] ?></a>
  <a style='margin-left:15px;'class="nav-link p-3  mb-1 shadow-sm bg-light text-danger " href="visteurs.php?page=supprimer_banque&id=<?=$donness['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
 </svg> Supprimer  <?=$donness['nom_banque'] ?> </a>
   ...
   <div class="col-lg-6 col-12">
    <div class="col-lg-12 ">
        <div class="card  w-100 shadow-lg pl-4 pr-4 pb-5 white"  >
          <div class="row pt-4 pl-4 pr-4 pb-4">
            <div class="col-lg-6">
            <?="<img src='".$donness['photo']."' class='card-img' ' alt=''>" ;?>
            </div>
            <div class="col-lg-6 mt-5">
               Nom:  <?=$donness['nom_banque'] ?><br>
              Adresse:  <?=$donness['adresse'] ?><br>
              Téléphone:  <?=$donness['numero'] ?><br>
            </div>
          </div>
          ...
          <div class="row">
           ...
           <div class="col-6 text-center bg-light  p-2" style='border: solid black 1px'>
              <h5> Elements</h5>
           </div>
           <div class="col-6 text-center bg-light  p-2" style='border: solid black 1px'>
               <h5>Montant</h5>
           </div>
           <div class="col-6  p-2" style='border: solid black 1px'>
               Date création
           </div>
           <div class="col-6 text-right  p-2" style='border: solid black 1px'>
           <?= $donness['date'] ?>
           </div>
           <div class="col-6  p-2" style='border: solid black 1px'>
               Montant de depôt
