...
<!DOCTYPE html>
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         ...
         <?="<img src='".$donness['photo']."' class='card-img' ' alt=''>" ;?>
               Nom:  <?=$donness['nom_banque'] ?>
              Adresse:  <?=$donness['adresse'] ?>
              Téléphone:  <?=$donness['numero'] ?>
          
         <a style="font-size:1.2rem;" class="nav-link t text-success"href="index.php?page=modifier_banque&id=<?=$donness['id'] ?>"> Modifier   <?=$donness['nom_banque'] ?> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                </svg> </a>
                <a  style="font-size:1.2rem;" class="nav-link   text-danger" href="index.php?page=supprimer_banque&id=<?=$donness['id'] ?>"> Supprimer  <?=$donness['nom_banque'] ?> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="col-lg-8 mt-2  col-12">
    <div class="col-lg-12 ">
        <div class="card  bg-light pt-5 w-100  pl-4 pr-4 pb-5 white"  >
          <div class="row">
           <div class="col-2 bg-light p-2" style='border: solid black 1px'>
         <h5>  Date création</h5>
           </div>
           <div class="col-3  p-2 bg-light" style='border: solid black 1px'>
              <h5> Montant de depôt</h5>
           </div>
           <div class="col-2  p-2 bg-light" style='border: solid black 1px'>
          <h5>    Frais bancaires</h5>
           </div>
           
           <div class="col-3  p-2 bg-light" style='border: solid black 1px'>
            <h5>  TVA bancaire (<?= $donness['taux_tva'] ?>%)</h5>
           </div>
           
           <div class="col-2  p-2 bg-light" style='border: solid black 1px'>
       <h5>     Montant à la Banque</h5>
           </div>
           </div>
           <div class="row">
           <div class="col-2 text-right  p-2" style='border: solid black 1px'>
           <?= $donness['date'] ?>
           </div>
          
           <div class="col-3 text-right  p-2" style='border: solid black 1px'>
           <?= $donness['montant'] ?>
           </div>
