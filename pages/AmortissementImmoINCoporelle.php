...
<?php
 ...
 <?php 
     ...
     echo $cout= $montant_ht+ $frais_accessoire;
         ...
         $stokks_marchandises=$bdd->prepare('INSERT INTO AmortissementImmoincorporelle
         (
        id_immobilisation,
        id_entreprise,
        immobilisation,
    ...
    header('Location:index.php?page=AmortissementImmoIncorporelle&id='.$_GET['id']);
...
<div class="card-body">
 <h1 class="card-title text-center text-light p-2 bg-secondary">
 Remplir les champs pour calculer amortissement de <?= $donnees['marchandise'] ?>
 </h1>
...
<label for="inputPassword" class="col-sm-1 col-form-label"><h6>Montant HT:</h6>  </label>
<div class="col-lg-2">
<input type="number" value='<?php
echo $montant_ht ?>'  name='montant_ht'class="form-control" id="inputCity "  placeholder="frais de Douane, installation,... ">
</div>
    </div>
<div class="form-group row">
<label for="inputPassword" class="col-sm-1 col-form-label"><h6>Frais accessoires:</h6>  </label>
<div class="col-lg-2">
<input type="number" value='0' name='frais_accesoire'class="form-control" id="inputCity "  placeholder="frais de Douane, installation,... ">
</div>
<label for="inputPassword" class="col-sm-2 col-form-label ml-1"><h6>Mois de mis en service  :</h6></label>
 <div class="col-lg-1">
...
<label for="inputPassword" class="col-sm-1 col-form-label"> <h6>Système  :</h6></label>
<div class="col-lg-2">
