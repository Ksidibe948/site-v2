...
<?php
  ...
  <div class="row">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <div class="overflow-auto" style='width:700%;
    height:1000px;'>
  ...
  <a  class="nav-link  " style="font-size:1.2rem; color:#A41FDE"  href="#">
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
    </svg>
    Données de <?= $resultat['nom'] ?>
    </a>
    <a class="nav-link  text-info" style="font-size:1.2rem;"   href="index.php?page=liberation_action&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
               ...
               </svg> Une liberation par <?= $resultat['nom'] ?></a>
    <a style="font-size:1.2rem;" class="nav-link  text-success" href="index.php?page=modifier_actionnaire&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                </svg> Modifier Actionnaire <?= $resultat['nom'] ?></a>
                <a  style="font-size:1.2rem;" class="nav-link text-danger" href="index.php?page=supprimer_actionnaire&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
               <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
               </svg> Supprimer Actionnaire <?= $resultat['nom'] ?></a>
    <a style='font-size:1.1rem' class="nav-link text-info"  href="index.php?page=nouveau_actionnaire&id=<?=$_SESSION['id'] ?>">
  ...
  <a  class="nav-link pl-2" style="font-size:1.2rem; " href="index.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
  ...
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   Factures
    ...
    <a  class="nav-link " style="font-size:1.1rem; "  href="index.php?page=facturesachats&id=<?=$_SESSION['id'] ?>">              
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
    <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
    <circle cx="3.5" cy="5.5" r=".5"/>
  ...
  <a  class="nav-link pl-2" style="font-size:1.2rem;" href="index.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
   ...
   CPC
    ...
    <div class="row " >
     <div class="col-12 ">
     <div class="card w-100 shadow-lg mb-4 mt-4 pl-3">
      <div class="row  ">
    <div class="col-lg-6 ">
...
<div class="col-6 text-center p-2" style='border:solid gray 1px'>
  Elements
 </div>
 <div class="col-6 text-center p-2" style='border:solid gray 1px' >
     Montants
      </div>
     <div class="col-6 text- p-2"style='border:solid gray 1px' >
...
<div class="col-6 text- p-2" style='border:solid gray 1px'>
   ...
   <?=   $part?>% 
    ...
    <div class="row mt-5 mr-1 ml-1 mb-3">
            <?php
$restes=$resultat['montant_souscrit'];
while ($reponse=$req->fetch()) {
 $restes=$restes-$reponse['montant_payer'];
  ?>
  <div class="col-12 " >
  <a class="nav-link text-dark" href="index.php?page=detail_action&id=<?=$reponse['id'] ?>">
      <div class="row" style='border:solid gray 1px'>
   <div class="col-12 text-center p-2  bg-secondary text-white"  style='border:solid gray 1px' >
   Libération 
   </div>
   <div class="col-6 text-center p-2" style='border:solid gray 1px' >
       Elements
