...
<!-- la partie inscription -->
                            ...
                            <div class="col-lg-12 ">
                            <div class="card   text-secondary pb-5 bg-light w-100" style="width: 18rem; ">
                            <div class="card-body">
                               
                              <form action="" method="POST" enctype="multipart/form-data">
                              <div class="form-group row ">
                            <div class="col-2"></div>
                               <label for="inputPassword" class="col-lg-2  bg-light bg-light  pl-5 col-form-label"><h6>Nom de la banque :</h6></label>
                              <div class="col-lg-2  bg-light bg-light">
                              ...
                              <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Photo de la banque :</h6></label>
                              ...
                              <div class="form-group row">
                              <div class="col-2"></div>
                               <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Numéro de la banque :</h6></label>
                              <div class="col-lg-2  bg-light">
                              ...
                              <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Montant de depôt :</h6></label>
                              <div class="col-lg-2  bg-light">
                              ...
                              <div class="form-group row">
                              <div class="col-2"></div>
                              <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Email de la banque :</h6></label>
                            <div class="col-lg-2  bg-light">
                            <input type="text" value='<?=  $element_banque['email'] ?>'  name='email' class="form-control" id="inputCity"  placeholder="  Ex:bmc@gmail.com">
                              ...
                              <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Frais des opérations  :</h6></label>
                              <div class="col-lg-2  bg-light">
                            ...
                            <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>Adresse de la Banque :</h6></label>
                              <div class="col-lg-2  bg-light">
                              <input type="text" value='<?=  $element_banque['adresse'] ?>'   name='adresse'class="form-control" id="inputCity " required  placeholder="  Ex: BMC ">
                              </div>
                              <div class="col-1"></div>
                     
                               <label for="inputPassword" class="col-lg-2  bg-light col-form-label bg-light pl-5"><h6>TVA bancaire  :</h6></label>
                              <div class="col-lg-2  bg-light">
