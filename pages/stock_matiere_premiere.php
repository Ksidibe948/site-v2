...
<?php
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $listeachat_marchandise=$bdd->prepare('SELECT id, marchandiseS, quantiteS,  DATE_FORMAT(date,"%d/%m/%Y à %Hh%imin%ss") AS date FROM stocks_matierepremiere where id_entrepriseS=? ORDER BY id DESC');
...
<div class="row">
     ...
     <a  class="nav-link p-3  mb-1 shadow-sm bg-light text-secondary bg-light bg-light " style="font-size:1.3rem;color:#A41FDE" href="index.php?page=Stocks&id=<?=$_SESSION['id'] ?>"> 
     <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
    </svg>
    Stocks
   </a>
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light  bg-light bg-light " style="font-size:1.3rem;color:#A41FDE"  href="index.php?page=stock_matiere_premiere&id=<?=$_SESSION['id'] ?>"> 
     <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
    </svg>
   ...
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light text-secondary bg-light bg-light "  style="font-size:1.2rem;" href="index.php?page=produits_exploitation&id=<?=$_SESSION['id'] ?>"> 
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
  </svg>
   Produits Exploitations
   </a>
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light text-secondary bg-light bg-light "  style="font-size:1.2rem;" href="index.php?page=produits_financiers&id=<?=$_SESSION['id'] ?>"> 
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
  </svg>
   Produits Financier
   </a>
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light text-secondary bg-light bg-light "  style="font-size:1.2rem;" href="index.php?page=produits_execeptionnels&id=<?=$_SESSION['id'] ?>"> 
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
  </svg>
   ...
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light text-secondary bg-light bg-light " style="font-size:1.3rem; "  href="index.php?page=factures&id=<?=$_SESSION['id'] ?>">              
   ...
   <?php 
       if ($verificaiton<=0) {
         ?>
         <div class="alert pl-5 ml-5 mt-5 alert-warning alert-dismissible fade show" role="alert">
  <h5><strong>Vous n'avez une matière première Stocker</strong> </h5>
...
<?php
  ...
  <div class="card shadow-lg  pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 text-white pt-2 text-center  bg-secondary"style='border:solid 0.5px gray'>
          <h1>La liste de Stock des matières premières</h1>
          </a>
        </div>
          </div> 
   <div class="row ">
          <div class="col-4 pt-2 text-left"style='border:solid 0.5px gray'>
          <h5>Dates de Stockage</h5> 
          </div>
 ...
 $total_stock='0';
    ...
    {
      $total_stock=$total_stock+$resultat['quantiteS'];
      if ($resultat['quantiteS']>0) {
        ?>
          <a  href="index.php?page=detail_stock_marchandise&id=<?=$resultat['id'] ?>" style='text-decoration:none; color:black'>
          <div class="row  ">
          <div class="col-4 pt-2 text-left"style='border:solid 0.5px gray'>
                <?= $resultat['date'] ?>
          </div>
          <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
          <?= $resultat['marchandiseS'] ?>
          </div>
          <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
          <?= $resultat['quantiteS'] ?>
          </div>
        ...
        ?>
          <a  href="index.php?page=detail_stock_marchandise&id=<?=$resultat['id'] ?>" style='text-decoration:none; color:red'> 
          <div class="row  ">
          <div class="col-4 pt-2 text-left"style='border:solid 0.5px gray'>
                <?= $resultat['date'] ?>
          </div>
          ...
          <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
          <?= $resultat['marchandiseS'] ?> à été Sortie
          </div>
          </div>
          </a>
    ...
    ?>
    <div class="row">
      <div class="col-8 text-left"style='border:solid 0.5px gray'><h5>Quantité total des matières premières  Stocker</h5></div>
      <div class="col-4 text-right"style='border:solid 0.5px gray'>   <h5> <?= $total_stock?></h5> </div>
    </div>
    </div>
    </div>
    </div>    
