...
<?php
       ...
       {   
            ...
            $modification->execute(array($montant_payer,$numero_banque ));
             ...
             charges_financieres(id_entreprise,nom_operation,montant_th, taux_tva,numero_banque,montant_payer)
             VALUES(?,?,?,?,?,?)
              ");
             $insert->execute(array( $_SESSION['id'],$nom_operation,  $montant_th,$taux_tva, $numero_banque, $montant_payer));
            
             header('Location:visteurs.php?page=charges_financiers&id='.$_SESSION['id']);
      }                 
         ?>
         <!-- header -->
...
<?php
 ...
 <a style='font-size:1.2rem' class="nav-link text-info mb-1 shadow-sm bg-light "  href="visteurs.php?page=nouveaucharges_financieres&id=<?=$_SESSION['id'] ?>">
             <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
             </svg>
  Ajouter Une Nouvelle  Charge Financière 
 </a>
   ...
   <div class="col-lg-6 col-12">      
              ...
              <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                Enregistre une Nouvelle charge Financière
                                </h1><hr>
