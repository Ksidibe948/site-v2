...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $listeachat_marchandise=$bdd->prepare("SELECT
     id, marchandiseS, quantiteS,  DATE_FORMAT(date,'%d/%m/%Y à %Hh%imin%ss') AS date
   FROM stoks_materiels WHERE id_entrepriseS=? ORDER BY id DESC");
...
<a  class="nav-link " style="font-size:1.2rem;" href="index.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
 ...
 CPC
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a class="nav-link text-light"  href="index.php?page=nouvellefacturevente_materiel&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Facture de autre vente</p>
                  ...
                  ?>
                   ...
                   <div class="card w-100 shadow-lg   " >
                    ...
                    <div class="row">
                     ...
                     Date d'achat: Le <?= $resultat['date'] ?>
                     </div>
                   </div><hr>
                    <div class="row">
                     <div  class="col-12 text-center" style='font-size:2rem; color:#A41FDE '>
                   ...
                   <div class="row">
                     ...
                     <span h2><?= $resultat['marchandiseS'] ?></span><br>
                     </div>
                   </div>
                  </div><hr>
                   </div>
