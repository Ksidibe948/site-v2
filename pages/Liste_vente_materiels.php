...
<a  class="nav-link " style="font-size:1.2rem;" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
 ...
 CPC
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a class="nav-link text-light"  href="visteurs.php?page=nouvellefacturevente_materiel&id=<?=$_SESSION['id'] ?>">
            ...
            <div class="col-lg-3">
               <?php 
                if ($resultat['quantiteS']>0) {
                  ?>
                    <a class="nav-link ligh text-secondary" href="visteurs.php?page=nouvellefacturevente_materiel&id=<?=$resultat['id'] ?>">
