...
<?php
   ...
   FROM achats,fournisseurs WHERE achats.id_fournisseur=fournisseurs.id AND achats. id_entreprise=? ORDER BY id DESC");
...
<div class="row">
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          ...
          <h1>La liste de Factures d'achats marchandise</h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="visteurs.php?page=achat&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
