...
<div class="col-12 text-center  bg-secondary text-white"  style='border:solid gray 1px' >
   ...
   <div class="col-1  text-left"  style='border:solid gray 1px'>
   <h5>  Débits</h5>
   </div>
   <div class="col-1  text-left" style='border:solid gray 1px' >
    <h5>Crédits</h5>
   </div>
   <div class="col-4 text-center" style='border:solid gray 1px' >
 <h5>Libélles</h5>
   </div>
   <div class="col-3 text-center" style='border:solid gray 1px' >
 <h5>Montant Débits</h5>
   </div>
   <div class="col-3 text-center" style='border:solid gray 1px' >
 <h5>Montant Crédits</h5>
   </div>
   <div class="col-12">
       <div class="row">
       <div class="col-1  text-left"  style='border:solid gray 1px'>
