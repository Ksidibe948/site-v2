...
?>
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        header('Location:index.php?page=DetailCessionImmoFinanciere&id='.$_GET['id']);
...
<div class="row">
 ...
 <a style=' font-size:1.1rem;;' class="nav-link text-success p-3  mb-1 shadow-sm bg-light " href="index.php?page=ModifierFacatureCessionImmoFinanciere&id=<?=$reponse['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
