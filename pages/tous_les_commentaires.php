    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active  mr-3">
          <a class="nav-link" href="index.php?page=utilisateurs"> Commentaires <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item mr-3">
            ...
            <div class="col-lg-2"> </div>
              <div class="col-lg-8">
                <div class="card w-100">
                  ...
                  <?= $commentaires['date'] ?>
                  <a href="index.php?page=supprimer_tous_commentaire&id=<?=$commentaires['id'] ?>&id_publications=<?= $getid?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
