          ...
          
                                {
                                        ...
                                        if ($_FILES['monfichier']['size'] <= 1000000)
                                        {
                                                ...
                                                if (in_array($extension_upload, $extensions_autorisees))
                                                {
                                                       ...
                                                       $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
                                                       $insert=$bdd->prepare('INSERT INTO fournisseurs
                                                       (id_entreprise,nom, telephone,adresse, logo)
                                                       VALUES (?,?,?,?,?)
                                                       ');
                                                       $insert->execute(array($_SESSION['id'], $nom,$telephone,$adresse,$image));
                                                       header('Location:index.php?page=fournisseurs&id='.$_SESSION['id']);
...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $select=$bdd->prepare('SELECT * FROM clients where id_entreprise=? ORDER BY id DESC');
...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  ...
  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a class="nav-link  " style="font-size:1.2rem;color:#A41FDE "  href="index.php?page=nouveau_clients&id=<?=$_SESSION['id'] ?>">
        ...
        <div class="col-lg-8">
                            ...
                            <div class="card-body">
                              ...
                              <label for="inputZip">Nom</label>
                                <input type="text"  name='nom'class="form-control mr-5" id="inputCity" required placeholder="GOOGLE">
                              </div>
                              </div>
                              ...
                              <label for="inputZip">téléphone</label>
                                <input type="tel"  name='telephone'class="form-control mr-5" id="inputCity" required placeholder="EX: +212 6 40 63 71 57">
                              </div>
                              </div>  
                              ...
                              <label for="inputZip">Adresse</label>
                                <input type="text"  name='adresse'class="form-control mr-5" id="inputCity" required placeholder="Paris5, rue=2, porte=20">
                              </div>
                              </div> 
                              ...
                              <label for="inputZip">Logo client</label>
