...
<div class="row">
   ...
   <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link  mb-1 shadow-sm bg-light" href="visteurs.php?page=JournalProduitNonCourant&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a style="font-size:1.2rem;" class="nav-link  text-success mb-1 shadow-sm bg-light" href="visteurs.php?page=modifier_produitexceptionnel&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a  style="font-size:1.2rem;" class="nav-link mb-1 shadow-sm bg-light text-danger" href="visteurs.php?page=supprime_produitsexceptionnel&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
