...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a class="nav-link   " href="index.php?page=comptabilité_analytique&id=<?=$_SESSION['id'] ?>"><i class="fas fa-chart-line"></i>  Comptabilités Analytiques
    </a>
    <a class="nav-link  " href="index.php?page=comptabilité_societes&id=<?=$_SESSION['id'] ?>"><i class="fas fa-hand-holding-usd"></i>  Comptabilités des Sociétés
    </a>
    <a class="nav-link  " href="index.php?page=comptabilité_approfondie&id=<?=$_SESSION['id'] ?>"><i class="fas fa-landmark"></i> Comptabilité Approfondie
    </a>
    </li>
    </ul>
  </div>
...
<div class="col-lg-9 ">         
 <div class="row ">
        ...
        <div class="col-lg-6 ">
        <a class="nav-link " style=' color:green' href="index.php?page=comptabilité_analytique&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg p-3 bg-white " >
         <div class="card-title text-center pt-2">
        ...
        <a class="nav-link " style=' color:green' href="index.php?page=comptabilité_societes&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100  shadow-lg p-3 bg-white"  >
         <div class="card-title text-center pt-2">
        ...
        <div class="col-lg-6 mt-2  ">
        <a class="nav-link "style=' color:green' href="index.php?page=comptabilité_approfondie&id=<?=$_SESSION['id'] ?>">
