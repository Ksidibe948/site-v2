...
<div class="row">
     ...
     <a  class="nav-link p-3  mb-1 shadow-sm bg-light  bg-light "  style="font-size:1.2rem;color:#A41FDE" href="index.php?page=produits&id=<?=$_SESSION['id'] ?>"> 
   ...
   <div class="row ">
    <div class="col-lg-4 ">
        <div class="card w-100  shadow-lg pb-2 bg-light  mb-2"  >  
        <div class="card-title text-center ">
        <a  class="nav-link text-secondary bg-light bg-light "  href="index.php?page=produits_exploitation&id=<?=$_SESSION['id'] ?>">              
        <hr> <p style='  font-size:1.5rem'>Produits exploitations</p>    <hr>
          <svg width="5em" padding-button='20px'color='#A41FDE' height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
        </a> 
        </div>
    ...
    <div class="col-lg-4  ">
        <div class="card w-100  shadow-lg pb-2 bg-light  mb-2"  >
        <div class="card-title text-center ">
        <a  class="nav-link text-secondary bg-light"  href="index.php?page=produits_financiers&id=<?=$_SESSION['id'] ?>"> 
        <hr> <p style='  font-size:1.5rem'>Produits Financiers</p>    <hr>
          <svg width="5em" color='#A41FDE' height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
          </a> 
        </div>
    ...
    <div class="col-lg-4  ">
        <div class="card w-100  shadow-lg pb-2 bg-light  mb-2"  >
        <div class="card-title text-center ">
        <a  class="nav-link text-secondary bg-light"  href="index.php?page=produits_execeptionnels&id=<?=$_SESSION['id'] ?>"> 
          <hr><p style='  font-size:1.5rem'>Produits Non Courants</p>    <hr>
          <svg width="5em" color='#A41FDE' height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
          </a> 
