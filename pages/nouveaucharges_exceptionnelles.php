...
<?php
       ...
       {   
            ...
            $modification->execute(array($montant_payer,$numero_banque ));
             ...
             charges_noncourantes(id_entreprise,nom_operation,montant_th, taux_tva,numero_banque,montant_payer)
             VALUES(?,?,?,?,?,?)
              ");
             $insert->execute(array( $_SESSION['id'],$nom_operation,  $montant_th,$taux_tva, $numero_banque, $montant_payer));
             header('Location:visteurs.php?page=charges_execeptionnels&id='.$_SESSION['id']);
      }                 
         ?>
...
<?php
  ...
  <?php
   ...
   <a style='font-size:1.3rem' class="nav-link text-info  p-3  mb-1 shadow-sm bg-light text-secondary"  href="visteurs.php?page=nouveaucharges_exceptionnelles&id=<?=$_SESSION['id'] ?>">
   ...
   <div class="col-lg-6 col-12">      
         ...
         <div class="row">
              ...
              <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <h1 class="card-title p-4  mt-5 bg-secondary text-light p-2 text-center">
                                Enregistre une Nouvelle charge Non Courante
                                </h1><hr>
                                <form action="" method="POST" enctype="multipart/form-data">
                                
                              <div class="form-group row">
                               
                              <label for="inputPassword" class="col-12 col-form-label "><h5>Nom de l'operation : </h5></label>
                              <div class="col-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label "><h5>Montant_th  HT  : </h5></label>
                              <div class="col-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label "><h5>TVA   : </h5></label>
                               <div class="col-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label "><h5> Bancaire  : </h5></label>
                               <div class="col-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label "><h5>Montant payer : </h5></label>
                               <div class="col-12">
