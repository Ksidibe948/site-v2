           ...
           if ( isset($_POST['nom'])
             ...
             AND isset($_POST['montant_souscrit'])
          ...
          
                                {
                                                       ...
                                                       header('Location:visteurs.php?page=actionnaires&id='.$getid);
...
<?php
  ...
  <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
   ...
   <a style="font-size:1.2rem; color:#A41FDE" class="nav-link  " href="visteurs.php?page=modifier_actionnaire&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
