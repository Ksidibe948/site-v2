...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $achat_matierepremiere=$bdd->prepare("SELECT
        achats_matierepremiere.id,
        achats_matierepremiere.id_fournisseur,
        achats_matierepremiere. id_entreprise,
        achats_matierepremiere.marchandise,
        achats_matierepremiere.quantite,
        achats_matierepremiere.prix,
        achats_matierepremiere.reduction,
        achats_matierepremiere.taux_reduction,
        achats_matierepremiere.taux_exompte,
        achats_matierepremiere.montant_transport,
        achats_matierepremiere.taux_tva,
        achats_matierepremiere. montant_emballage,
        achats_matierepremiere. montant_avance,
        achats_matierepremiere. monyen_payement,
        achats_matierepremiere. montant_payement,
      fournisseurs.nom,
      fournisseurs.telephone,
      fournisseurs. adresse,
      fournisseurs.logo,
        DATE_FORMAT(  achats_matierepremiere.date,'%d/%m/%Y à %Hh%imin%ss') AS date
   FROM achats_matierepremiere,fournisseurs WHERE achats_matierepremiere.id_fournisseur=fournisseurs.id AND achats_matierepremiere. id=? ORDER BY id DESC");
  $achat_matierepremiere->execute(array( $_GET['id']));
  $donnees=$achat_matierepremiere->fetch();
   $compte=$achat_matierepremiere->rowcount();
 ?>
...
<div class="row">
   ...
   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    Factures Achats
      ...
      <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link p-3  mb-1 shadow-sm bg-light " href="visteurs.php?page=JournalFactureAchatMateriel&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <a style="font-size:1.2rem;" class="nav-link p-3  mb-1 shadow-sm bg-light  text-success" href="visteurs.php?page=modifierfactureachatmatierepremiere&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a  style="font-size:1.2rem;" class="nav-link p-3  mb-1 shadow-sm bg-light text-danger"  href="visteurs.php?page=supprimer_achatmatiere_premiere&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row ml-2 mr-2 ">
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-6 col-xl-6  text-center  text-dark bg-light" style='border:solid black 0.5px'>
                    <h6>Elements</h6>
                  </div>
