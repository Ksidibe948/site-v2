...
<?php
   ...
   FROM AchatsImmoIncorporelle,fournisseurs WHERE AchatsImmoIncorporelle.id_client=fournisseurs.id AND      AchatsImmoIncorporelle.id_client=? ORDER BY id DESC");
...
<?php
 ...
 <?php
  ...
  <h5> vous n'avez pas encore payé une immobilisation Incorporelle  chez <?=$resultat['nom']?></h5>
