...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=utilisateurs">Accueil <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item  mr-3">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-3" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-brightness-high" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="nav-link text-dark" href="visteurs.php?page=demande"> 
  ...
  <div class="card-body">
    <h5 class="card-title"><?="<img src='".$donnes['images']."' class='images' style='width:1.5rem;' alt=''>" ;?>   <?=$donnes['nom']?></h5>
