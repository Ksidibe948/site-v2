...
<?php
  ...
  <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link p-3  mb-1 shadow-sm bg-light " href="index.php?page=JournalFactureAchatImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a style="font-size:1.2rem;" class="nav-link p-3  mb-1 shadow-sm bg-light text-success" href="index.php?page=modifierFAImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <a  style="font-size:1.2rem;" class="nav-link p-3  mb-1 shadow-sm bg-light text-danger" href="index.php?page=supprimeFAImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
