...
<?php
   ...
   $achamarchandises=$bdd->prepare("SELECT
         ...
         AchatsImmoIncorporelle.reduction,
         AchatsImmoIncorporelle.taux_reduction,
         AchatsImmoIncorporelle.taux_exompte,
         AchatsImmoIncorporelle.montant_transport,
         AchatsImmoIncorporelle.taux_tva,
         AchatsImmoIncorporelle. montant_emballage,
         AchatsImmoIncorporelle. montant_avance,
         AchatsImmoIncorporelle.net_a_payer,
      fournisseurs.nom,
...
<?php
  ...
  <?php
   ...
   <!DOCTYPE html>
     ...
     <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        ?>
         <a style="font-size:1.2rem; font-family:arial" class="nav-link  p-3  mt-2   text-info" href="index.php?page=payementAchatImmoIncorporelle&id=<?=$_GET['id'] ?>">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
       ...
       ?>
         <a style="font-size:1.2rem; font-family:arial" class="nav-link  p-3   "href="index.php?page=JournalFactureAchatImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<a style="font-size:1.2rem; font-family:arial" class="nav-link text-primary p-3   "href="index.php?page=AmortissementImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-graph-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0zm10 11.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-1 0v2.6l-3.613-4.417a.5.5 0 0 0-.74-.037L7.06 8.233 3.404 3.206a.5.5 0 0 0-.808.588l4 5.5a.5.5 0 0 0 .758.06l2.609-2.61L13.445 11H10.5a.5.5 0 0 0-.5.5z"/>
</svg> Amortissement</a>
        <a style="font-size:1.2rem;" class="nav-link  p-3     text-success" href="index.php?page=modifierFAImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
          </svg> Modifier </a>
          <a  style="font-size:1.2rem;" class="nav-link  p-3    text-danger"  href="index.php?page=supprimeFAImmoIncorporelle&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
         </svg> Supprimer  </a>  

         <a style="font-size:1.2rem;color:#A41FDE" class="nav-link  p-3   "    href="index.php?page=AchatsImmobilisationsIncorporelles&id=<?=$_SESSION['id'] ?>">
