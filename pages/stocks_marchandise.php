...
<?php
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $listeachat_marchandise=$bdd->prepare('SELECT id, marchandiseS, quantiteS,  DATE_FORMAT(date,"%d/%m/%Y à %Hh%imin%ss") AS date FROM stoks_marchandise where id_entrepriseS=? ORDER BY id DESC');
...
<div class="row">
   ...
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light  bg-light bg-light " style="font-size:1.3rem;color:#A41FDE" href="index.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>"> 
     <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
    </svg>
    Stocks Marchandises
  ...
  <h5><strong>Vous n'avez une marchandise Stocker</strong> </h5>
...
<?php
  ...
  <div class="card shadow-lg  pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          ...
          <h1>La liste de Stock des marchandises</h1>
          </a>
        </div>
          </div> 
   <div class="row ">
 ...
 $total_stock='0';
    ...
    ?>
    <div class="row">
      <div class="col-8 text-left"style='border:solid 0.5px gray'><h5>Quantité total des marchandises Stocker</h5></div>
