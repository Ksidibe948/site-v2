...
if (isset($_GET['id'])) {
   ...
   FROM achats,clients WHERE achats.id_client=clients.id AND achats.id=? ORDER BY id DESC");
...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a class="nav-link  active" style='color:#A41FDE;' style='color:green;' href="visteurs.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>"><i class="fas fa-chart-line"></i>Stocks de Marchandises</a>
    </li>
    </ul>
  </div>
</nav>
   ...
   <div class="row ">
     <div class="card w-100 shadow-lg p-3 bg-white " >
      ...
      <div class="col-lg-3  mt-2 pt-2 pb-2 text-center"style='border:solid black 1px '>
        ...
        <div class='imagess'>
        <img src="../site/images/stocks_marchandises.jpg" class="card-img" alt="">
      </div>
      </div>
