...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a class="nav-link  active" style='color:#A41FDE;' style='color:green;' href="index.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>"><i class="fas fa-chart-line"></i>Stocks de Marchandises</a>
    </li>
    </ul>
  </div>
</nav>
