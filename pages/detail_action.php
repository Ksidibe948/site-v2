...
if (isset($_GET['id'])) {
  $getid=$_GET['id'];
 $req=$bdd->prepare("SELECT id, id_actionnaire,apport,numero_banque,montant_payer,DATE_FORMAT(date,'%d/%m/%Y à %Hh%imin%ss') AS date from liberations where id=? order by id desc");
 $req->execute(array($getid));
 $reponse=$req->fetch();
}?>
...
<?php
  ...
  <div class="row">
    ...
    <a  class="nav-link p-3  mb-1 shadow-sm bg-light bg-light " style="font-size:1.2rem; color:#A41FDE"  href="index.php?page=detail_action&id=<?=$_GET['id'] ?>">
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
   </svg>
    Details cette liberation  
   </a>
   <a  class="nav-link p-3  mb-1 shadow-sm bg-light bg-light text-success"  style="font-size:1.2rem;" href="index.php?page=modifier_actions&id=<?=$getid ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
   </svg> Modifier cette liberation
   <a class="nav-link p-3  mb-1 shadow-sm bg-light bg-light text-danger " style="font-size:1.2rem; " href="index.php?page=supprimer_action&id=<?=$getid ?>&id_actionnaire=<?=$reponse['id_actionnaire']?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
   </svg> Supprimer cette liberation </a>
  </a> 
  ...
  <h5><div class="col-12 mt-5">
      <div class="row">
   <div class="col-12 text-center p-2  bg-secondary text-white"  style='border:solid black 1px'>
<h4>   Libération </h4>
   </div>
   <div class="col-4 text- p-2" style='border:solid black 1px'>
     Date de liberation
   </div>
   <div class="col-4 text- p-2" style='border:solid black 1px'>
     Le type d'Apport
   ...
   <div class="col-4 text-right p-2"  style='border:solid black 1px'>
     Le <?= $reponse['date'] ?>
   </div>
   <div class="col-4 text-right p-2"  style='border:solid black 1px'>
      <?= $reponse['apport'] ?>
