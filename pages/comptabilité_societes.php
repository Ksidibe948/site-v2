...
<div class="container">
   ...
   <div class="row ">
    ...
    <div class="card-body">        
      <h5><ul>
      <a  class="nav-link " style=' color:#A41FDE' href="visteurs.php?page=banque&id=<?=$_SESSION['id'] ?>"><li> Banque</li></a>
      <a  class="nav-link " style=' color:#A41FDE' href="visteurs.php?page=capital&id=<?=$_SESSION['id'] ?>"><li>Capital</li></a>
      <a  class="nav-link " style=' color:#A41FDE' href="visteurs.php?page=actionnaires&id=<?=$_SESSION['id'] ?>"><li>Actionnaires</li></a>   
    </ul>
    </div>
    </div>
