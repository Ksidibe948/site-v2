...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $CessionImmoCorporelle=$bdd->prepare("SELECT
       CessionImmoCorporelle.id,
       CessionImmoCorporelle.id_client,
       CessionImmoCorporelle. id_entreprise,
       CessionImmoCorporelle.marchandise,
       CessionImmoCorporelle.quantite,
       CessionImmoCorporelle.prix,
       CessionImmoCorporelle.reduction,
       CessionImmoCorporelle.taux_reduction,
       CessionImmoCorporelle.taux_exompte,
       CessionImmoCorporelle.montant_transport,
       CessionImmoCorporelle.taux_tva,
       CessionImmoCorporelle. montant_emballage,
       CessionImmoCorporelle. montant_avance,
       CessionImmoCorporelle. monyen_payement,
       CessionImmoCorporelle. montant_payement,
        clients.nom,
        clients.telephone,
        clients. adresse,
        clients.logo,
        DATE_FORMAT(CessionImmoCorporelle.date,'%d/%m/%Y à %Hh%imin%ss') AS date
   FROM  CessionImmoCorporelle,clients WHERE  CessionImmoCorporelle.id_client=clients.id AND  CessionImmoCorporelle. id=? ORDER BY id DESC");
   $CessionImmoCorporelle->execute(array($_GET['id']));
   $compte=  $CessionImmoCorporelle->rowcount();
   $donnees=$CessionImmoCorporelle->fetch();
 ?>
...
Cessions Immobilisations Corporelles
 ...
 <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link  p-3  mb-1 shadow-sm bg-light " href="visteurs.php?page=JournalFactureCessionImmoCorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
           ...
           <?= $donnees['date'] ?>
            ...
            <div class="row ml-2 mr-2">
              <div class="col-lg-12 text-center text-secondary">
               <h1> Journal de la Facture   N°<?= $donnees['id'] ?></h1>
              </div>
              </div>
              <hr>
            <div class="row ml-2 mr-2 ">
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-4 text-left"style='border:solid black 0.5px'>
                    <h6> Exompte accorde au Client <?= $donnees['nom'] ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                ...
                ?>
                  ...
                  <div class="col-4 text-left"style='border:solid black 0.5px'>
                    <h6>Avance et Accord Sur la Facture de <?= $donnees['marchandise'] ?> (<?= $donnees['taux_tva'] ?>) </h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                ...
                ?>
                  ...
                  <div class="col-4 text-right"style='border:solid black 0.5px'>
                    <h6>Produit de Cession de  <?= $donnees['marchandise'] ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                  ...
                  <div class="col-4 text-right"style='border:solid black 0.5px'>
                    <h6>  Transport sur  <?= $donnees['marchandise'] ?> ( <?= $donnees['taux_exompte'] ?>)  </h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                ...
                ?>
                  ...
                  <div class="col-4 text-right"style='border:solid black 0.5px'>
                    <h6>   Tva Facturé Sur la Facture de  <?= $donnees['marchandise'] ?>)  </h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
        ...
        <div class="row mt-4">
         ...
         <hr><div class="row">
           ...
           <?= $donnees['date'] ?>
            ...
            <div class="row ml-2 mr-2">
              <div class="col-lg-12 text-center text-secondary">
               <h1> Journal du Payement  de la Facture   N°<?= $donnees['id'] ?></h1>
              </div>
              </div>
              <hr>
            <div class="row ml-2 mr-2 ">
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
                  <h6><?=  $donnees['montant_payement'] ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                  ...
                  <div class="col-4 text-left"style='border:solid black 0.5px'>
                    <h6>Reste à Retourner Sur la Facture  <?=$donnees ['marchandise']  ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
                  <h6><?=$reste?></h6>
                  </div> 
                  ...
                  <div class="col-4 text-text-left"style='border:solid black 0.5px'>
                    <h6>Reste à Recupérer sur la Facture de <?=$donnees ['marchandise']  ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
                  <h6><?=$reste?></h6>
                  </div> 
                ...
                <div class="row">
                 ...
                 $net_à_payer 
                  ...
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
                  <h6><?=
                  $donnees['montant_payement'] + $reste
                  ?></h6>
                  </div>
                  </div>
         ...
         <hr><div class="row">
           ...
           <?= $donnees['date'] ?>
            ...
            <div class="row ml-2 mr-2">
              <div class="col-lg-12 text-center text-secondary">
               <h1> Journal de l'Effet de commerce sur la Facture   N°<?= $donnees['id'] ?></h1>
              </div>
              </div>
              <hr>
            <div class="row ml-2 mr-2 ">
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-4 text-left"style='border:solid black 0.5px'>
                    <h6>Clients <?= $donnees['nom'] ?> Effet à récevoir</h6>
                  </div>
                  <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
                  <h6><?=  $net_à_payer?></h6>
                  </div>
