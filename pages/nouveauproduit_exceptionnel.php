...
<?php
       ...
       {   
            ...
            $inserts->execute(array( $_SESSION['id'], $montant_th));
             ...
             header('Location:visteurs.php?page=produits_execeptionnels&id='.$_SESSION['id']);
      }                 
         ?>
...
<div class="row">
   ...
   <a style='font-size:1.2rem' class="nav-link text-info p-3  mb-1 shadow-sm bg-light "  href="visteurs.php?page=nouveauproduit_exceptionnel&id=<?=$_SESSION['id'] ?>">
