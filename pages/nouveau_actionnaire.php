                                        ...
                                        if ($_FILES['monfichier']['size'] <= 1000000)
                                        {
                                                ...
                                                if (in_array($extension_upload, $extensions_autorisees))
                                                {
                                                       ...
                                                       if ($count==1) {
                                                        ...
                                                        header('Location:index.php?page=actionnaires&id='.$_SESSION['id']);
                                                       }
...
<?php
  ...
  <div class="row">
     ...
     <a  class="nav-link p-3  mb-1 shadow-sm bg-light bg-light  bg-light " style="font-size:1.3rem;color:#A41FDE" href="index.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
