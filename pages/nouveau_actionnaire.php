...
<?php
           if (isset($_FILES['monfichier']) AND $_FILES['monfichier']['error'] == 0
             ...
             AND isset($_POST['montant_souscrit'])
           )
          
                                {
                                        ...
                                        if ($_FILES['monfichier']['size'] <= 1000000)
                                        {
                                                ...
                                                if (in_array($extension_upload, $extensions_autorisees))
                                                {
                                                       ...
                                                       $montant_souscrit=$_POST['montant_souscrit'];
                                                       $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
                                                      
                                                       $modi=$bdd->prepare('UPDATE capitals SET capital= capital - ? WHERE id_entreprise=?');
                                                       $modi->execute(array($montant_souscrit,$_SESSION['id']));
                                                      
                                                       
                                                       $select=$bdd->prepare('SELECT* FROM actionnaires WHERE telephone=? ');
                                                       $select->execute(array($telephone));
                                                       $count=$select->rowcount();
                                                       if ($count==1) {
                                                          $erreur='';
                                                       } else {
                                                        $insert=$bdd->prepare('INSERT INTO actionnaires
                                                        (id_entreprise ,nom,prenom, telephone,adresse, logo,montant_souscrit)
                                                        VALUES (?,?,?,?,?,?,?)
                                                        ');
                                                        $insert->execute(array($_SESSION['id'],$nom,$prenom,$telephone,$adresse,$image,  $montant_souscrit));
                                                        header('Location:visteurs.php?page=actionnaires&id='.$_SESSION['id']);
                                                       }
...
<?php
  ...
  <div class="row">
     ...
     <a  class="nav-link p-3  mb-1 shadow-sm bg-light bg-light  bg-light " style="font-size:1.3rem;color:#A41FDE" href="visteurs.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="col-lg-6 col-12">    
                            ...
                            <div class="card-body">
                               <hr> <h1 class="card-title text-light bg-secondary  p-4 text-center">
                              ...
                              <label for="inputZip"> <hr>Nom </hr></label>
                                <input type="text"  name='nom'class="form-control " id="inputCity" required placeholder="SIDIBE">
                              </div>
                              </div>
                              <div class="form-row">
                              
                              <div class="form-group col-12  ">
                              <label for="inputZip"> <hr>Prenom</hr></label>
                                <input type="text"  name='prenom'class="form-control " id="inputCity" required placeholder="KARIM ">
                              </div>
                              </div>
                              ...
                              <div class="form-group col-12  ">
                              <label for="inputZip"> <hr>téléphone</hr></label>
                                <input type="tel"  name='telephone'class="form-control " id="inputCity" required placeholder="EX: +212 6 40 63 71 57">
                              </div>
                              </div>  
                              ...
                              <label for="inputZip  ">Adresse</hr></label>
                                <input type="text"  name='adresse'class="form-control  " id="inputCity" required placeholder="Paris5, rue=2, porte=20">
                              </div>
                              </div> 
                              ...
                              <label for="inputZip"> <hr>Photo de l'actionnaire</hr></label>
                                <input type="file"  name='monfichier'class="form-control " id="inputCity" >
                              </div>
                              </div> 
                              ...
                              <div class="form-group col-12  ">
                              <label for="inputZip"> <hr>Montant souscrit</hr></label>
                                <input type="number" value='<?= $resultatss['capital'] ?>'  name='montant_souscrit'class="form-control " id="inputCity" required placeholder="EX: 200 000">
                              </div>
                              </div>
                              ...
                              if (isset($erreur)) {?>
                                ...
                                <?=$erreur='Cet actionnaire existe déja ! ';?>
                                </div>
                                </div>
                             <?php
                              }
