...
?>
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        header('Location:visteurs.php?page=detail_vente_materiel&id='.$_GET['id']);
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures Ventes de materiels <span style='color:green'>( <?=$vente_materiels?>)</span> 
  ...
  <a class="nav-link  " style='font-size:1.3rem ;color:#A41FDE' href="visteurs.php?page=modifier_facture_vente_materiel&id=<?=$reponse['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a style='font-size:1.3rem' class="nav-link  text-info "  href="visteurs.php?page=Liste_vente_materiels&id=<?=$_SESSION['id'] ?>">
