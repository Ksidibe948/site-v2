...
<div class="row">
  ...
  <hr>
 <a  class="nav-link pl-2 " style="font-size:1.2rem;color:#A41FDE" href="visteurs.php?page=Stocks&id=<?=$_SESSION['id'] ?>"> 
...
<a  class="nav-link pl-2" style="font-size:1.2rem;" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
 ...
 <div class="col-lg-8 col-10 ml-5 mt-5 ">    
   <div class="row ">
        <div class="col-lg-4 ">
        <a class="nav-link "  href="visteurs.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>">
         ...
         <div class="col-lg-4 ">
        <a class="nav-link "  href="visteurs.php?page=stock_matiere_premiere&id=<?=$_SESSION['id'] ?>">
        <div class="card w-100 shadow-lg p-3 bg-light "  >
         <div class="card w-100 shadow-lg pb-5 bg-white "  >
