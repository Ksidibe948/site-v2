...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
     <ul  class="navbar-nav mr-auto mt-2 mb-5 mt-lg-0">
      <li class="nav-item ">
      <a   class="nav-link active " style='  font-size:1.2rem'  href="visteurs.php?page=utilisateurs">
  ...
  <div class="container">
              ...
              <div class="col-lg-6">
               <a class="nav-link text-dark" href="visteurs.php?page=les_articles&id=<?=$reponses['id_publications'] ?>"> 
