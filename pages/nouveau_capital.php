...
<?php
          ...
          
       {
             ...
             echo $actions= $_POST["nombre_d'action"];
             
             $insert=$bdd->prepare("INSERT INTO 
             capitals(id_entreprise,capital,actions)
             VALUES(?,?,?)
              ");
             $insert->execute(array( $_SESSION['id'], $capital,$actions));
...
<div class="row">
   ...
   <div class="col-lg-6 col-12">
                            ...
                            <div class="col-lg-10">
                            <div class="card shadow-lg w-100 bg-light text-secondary"  style="width: 18rem; ">
                            <div class="card-body">
                                <hr><h1 class="card-title text-center bg-secondary text-light p-4 ">
                                Nouveau Capital
                                </h1><hr>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12">
                              <input type="number"  name='capital'class="form-control" id="inputCity "  placeholder="  Ex: 1000000 ">
                              </div>
                            </div><hr>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12">
                              <input type="number"  name="nombre_d'action"   class="form-control" id="inputCity "  placeholder="  Ex: 100 ">
                              </div>
                            </div><hr>
