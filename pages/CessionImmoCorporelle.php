...
<?php
   ...
   FROM  CessionImmoCorporelle,clients WHERE  CessionImmoCorporelle.id_client=clients.id AND  CessionImmoCorporelle. id_entreprise=? ORDER BY id DESC");
   $CessionImmoCorporelle->execute(array($_SESSION['id']));
...
<div class="row">
   ...
   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    Factures
     ...
     <a  class="nav-link  p-3  mb-1 shadow-sm bg-light "  style="font-size:1.2rem;" href="index.php?page=Cessions&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
...
Cessions Immobilisations Corporelles
   ...
   <div class="row ">
    <div class="col-lg-12 mt-3 ">
        ...
        <a  class="nav-link text-white"  href="index.php?page=ListeAchatImmoCorporelle&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'> Enrgistre une  cession immobilisation Corporelle</p>
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 p-4 mb-2 text-center text-light p  bg-secondary"style='border:solid 0.5px gray'>
          <h1> La Liste des Factures de Cessions Immobilisations Corporelles </h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    while($resultat=  $CessionImmoCorporelle->fetch())
    {
        ?>
        <a class="link text-dark "  href="index.php?page=DetailCessionImmoCorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
