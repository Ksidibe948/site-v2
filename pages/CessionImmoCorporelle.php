...
Cessions Immobilisations Corporelles
 ...
 <a style='font-size:1.3rem' class="nav-link  p-3  mb-1 shadow-sm bg-light text-info "  href="visteurs.php?page=ListeAchatImmoCorporelle&id=<?=$_SESSION['id'] ?>">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="visteurs.php?page=DetailCessionImmoCorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
