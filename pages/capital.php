    ...
    <div class="row  ">
     ...
     while($resultat=$select->fetch())
     {
         ...
         <div class="col-lg-4">
          ...
          <a class="nav-link text-secondary bg-light" href="visteurs.php?page=detail_actionnaire&id=<?=$resultat['id'] ?>">
     ...
     ?>
        ...
        <div class="card  w-100 shadow-lg  bg-info text-secondary mb-3"  >
        <div class="card-title text-center pt-5">
        <a style='font-size:1.1rem'class="nav-link  text-light  " href="visteurs.php?page=nouveau_capital&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Ajouter un Capital</p>
