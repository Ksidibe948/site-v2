...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
     ...
     <a  style='  font-size:1.2rem' class=' pl-2 pr-2'href="index.php?page=Modifications.publications&id=<?=$reponses['id_publications'] ?>"><svg width="1.2em" height="1.2em"  viewBox="0 0 16 16" class="bi pb-1 bi-gear-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
       <path fill-rule="evenodd" d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 0 0-5.86 2.929 2.929 0 0 0 0 5.858z"/>
     </svg>Modifier</a> <br>

     <a style='  font-size:1.2rem' class=' pl-2 pr-2' href="index.php?page=supprimer_publications&id=<?=$reponses['id_publications'] ?>"><svg width="1.2em" height="1.2em" color="red" viewBox="0 0 16 16" class="bi pb-1 bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="card mb-3 shadow-lg  " >
        <a class="nav-link text-dark " href="index.php?page=autor&id=<?=$reponses['id_utilisateurs'] ?>">
        <div class="card-img bg-light pb-2 pt-2 pl-5" style=' border-radius: 20px;'>
          ...
          <div class='imagess'>
           ...
           <div class="col-lg-1 "></div>
             ...
             <div class="card" >
             <a style='text-decoration: none; color:#A41FDE' href="index.php?page=action&t=1&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" color='#A41FDE' class="bi bi-hand-thumbs-up mb-2 mt-2  " fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             ...
             <div class="card">
             <a style='text-decoration: none; color:#A41FDE'  class='' href="index.php?page=action&t=2&id=<?=$_GET['id'] ?>"><svg width="1.5em" color='green' height="1.5em" viewBox="0 0 16 16" class="bi  bi-hand-thumbs-down mb-2 mt-2 " fill="currentColor" xmlns="http://www.w3.org/2000/svg">
