...
<div class="row">
     ...
     <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul  class="navbar-nav  mr-auto ">
         ...
         <a style='font-size:1.1rem' class="nav-link text-white ml-5 bg-info " href="index.php?page=nouveau_clients&id=<?=$_SESSION['id'] ?>">
     ...
     while($resultat=$select->fetch())
        {
            ...
            <div class="col-2 ">
             ...
             <a class="nav-link text-center text-secondary " href="index.php?page=detail_clients&id=<?=$resultat['id'] ?>">
                <div class='imagess'>
