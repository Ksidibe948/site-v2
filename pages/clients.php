...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  ...
  <hr>
  <a class="nav-link  " style="font-size:1.2rem; color:#A41FDE  "   href="index.php?page=clients&id=<?=$_SESSION['id'] ?>">              
  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a class="nav-link  text-info" style="font-size:1.2rem;"  href="index.php?page=nouveau_clients&id=<?=$_SESSION['id'] ?>">
  ...
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   Factures de autre charges <span style='color:green'>( <?=$autres_charges?>)</span> 
    ...
    <a  class="nav-link  " style="font-size:1rem; "  href="index.php?page=achats&id=<?=$_SESSION['id'] ?>">              
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
    <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
    <circle cx="3.5" cy="5.5" r=".5"/>
  ...
  <a  class="nav-link " style="font-size:1.2rem;" href="index.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
   ...
   CPC
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a class="nav-link text-light"  href="index.php?page=nouveau_clients&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Ajouter un Client</p>
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ...
            <a class="nav-link " href="index.php?page=detail_clients&id=<?=$resultat['id'] ?>">
