...
<?php
       ...
       {   
            ...
            $modifications = $bdd->prepare("update somme_produits set montant = montant +  ? where id_entreprise = ? ");
            $modifications->execute(array(  $montant_th,$_SESSION['id']));
            
            $inserts=$bdd->prepare("INSERT INTO 
            somme_produits(id_entreprise,montant)
            VALUES(?,?)
             ");
            $inserts->execute(array( $_SESSION['id'], $montant_th));
           
             $insert=$bdd->prepare("INSERT INTO 
             autre_produits(id_entreprise,nom_operation,montant_th, taux_tva,numero_banque,montant_payer)
             VALUES(?,?,?,?,?,?)
              ");
             $insert->execute(array( $_SESSION['id'],$nom_operation,  $montant_th,$taux_tva, $numero_banque, $montant_payer));
            
             header('Location:index.php?page=autres_produits&id='.$_SESSION['id']);
      }                 
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="index.php?page=autres_produits">Listes autres produits<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active  mr-3">
              <a class="nav-link" href="">Nouveau produit<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3">
     ...
     <div class="container">
         <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                Enregistre un nouveau Entre d'argent
                                </h5><hr>
                            ...
                            <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">montant_th  HT</label>
                              <div class="col-lg-3">
