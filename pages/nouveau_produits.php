...
<?php
       ...
       {   
            ...
            $inserts->execute(array( $_SESSION['id'], $montant_th));
             ...
             header('Location:visteurs.php?page=autres_produits&id='.$_SESSION['id']);
      }                 
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=autres_produits">Listes autres produits<span class="sr-only">(current)</span></a>
            </li>
