...
<?php
          ...
          
       {
            ...
            header('Location:index.php?page=detail_action&id='.$getid);
...
<a  class="nav-link "  style="font-size:1.2rem;color:#A41FDE" href="index.php?page=modifier_actions&id=<?=$getid ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
