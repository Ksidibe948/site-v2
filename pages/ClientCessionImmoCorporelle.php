...
<?php
   ...
   FROM  CessionImmoCorporelle,clients WHERE  CessionImmoCorporelle.id_client=clients.id AND  CessionImmoCorporelle.id_client=? ORDER BY id DESC");
...
<div class="row">
 ...
 <?php
    ...
    <?php
        ...
        ?>
        <div class="alert text-right alert-warning alert-dismissible fade show" role="alert">
  <h5> vous n'avez pas encore vendu une immobilisation Corporelle  à <?=$resultat['nom']?></h5>
