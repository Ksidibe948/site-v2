...
<div class="row">
  ...
  <div class="col-lg-9 text-center col-12"> 
   <div class="row ">
    <?php
       if ( $compte>0) {
            ?>  
  <div class="card  pl-4 pb-5 bg-light pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 pt-2 text-center text-light  bg-secondary p-4 mb-2"style='border:solid 0.5px gray'>
          <h1>La liste des ventes Marchandises effectuer avec <?= $resultat['nom'] ?></h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    while($resultat= $ventes_marchandise->fetch())
    {
        ?>
        <a class="link text-dark "  href="index.php?page=detail_vente_marchandise&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
