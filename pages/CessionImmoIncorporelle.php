...
<?php
   ...
   FROM  CessionImmoIncorporelle,clients WHERE  CessionImmoIncorporelle.id_client=clients.id AND  CessionImmoIncorporelle. id_entreprise=? ORDER BY id DESC");
   $CessionImmoIncorporelle->execute(array($_SESSION['id']));
...
<div class="row">
  ...
  Cessions Immobilisations Incorporelle
   ...
   <div class="row ">
    <div class="col-lg-12 mt-3 ">
        ...
        <a  class="nav-link text-white"  href="index.php?page=ListeAchatImmoIncorporelle&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'> Enrgistre une cession immobilisation Financière</p>
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 pt-2 mb-3 text-center text-light   bg-secondary"style='border:solid 0.5px gray'>
          <h1> La Liste des Factures de Cessions Immobilisations Incorporelles </h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    while($resultat=  $CessionImmoIncorporelle->fetch())
    {
        ?>
        <a class="link text-dark "  href="index.php?page=DetailCessionImmoIncorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
