...
<?php
       ...
       {   
            ...
            header('Location:index.php?page= detail_chargesfinanciere&id='.$getid);
...
<?php
 ...
 Charges Financier
        ...
        <a style="font-size:1.2rem;" class="nav-link mb-1 shadow-sm bg-ligh text-success" href="index.php?page=modifier_charges_financiere&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
