       ...
       ) 
       {
        $getid=$_GET['id'];
         ...
         $stock->execute(array($marchandise,$getid));
          header('Location:index.php?page=DetailAchatImmoCorporelle&id='.$_GET['id']);
...
<div class="row">
  ...
  <a style="font-size:1.2rem;" class="nav-link p-3  mb-1 shadow-sm bg-light text-success" href="index.php?page=modifierFAImmoCorporelle&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
