...
<a style="font-size:1.2rem;" class="nav-link text-success" href="visteurs.php?page=modifier_achat_immobilisation&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
           ...
           <a  style="font-size:1.2rem;" class="nav-link text-danger" href="visteurs.php?page=supprimer_achat_immobilisation&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
