                                        ...
                                        if ($_FILES['monfichier']['size'] <= 1000000)
                                        {
                                                ...
                                                if (in_array($extension_upload, $extensions_autorisees))
                                                {
                                                        ...
                                                        $req->execute(array( $image,$_SESSION['id']));
                                                            ...
                                                            header('Location:visteurs.php?page=profil&id='.$_SESSION['id']);   header('Location:visteurs.php?page=profil&id='.$_SESSION['id']);   
    ...
    <ul class="navbar-nav ml-5 ">
      ...
      <li class="nav-item dropdown">
       ...
       <?= $_SESSION['nom']?>
        ...
        <a class="nav-link text-dark  " href="visteurs.php?page=publication&id=<?=$_SESSION['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
