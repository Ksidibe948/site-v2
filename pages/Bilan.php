  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
           <div class="col-12 text-center text-light bg-secondary">
            <h3 style='padding-top:10px'>Bilan de  <?=$_SESSION['nom'] ?></h3>  
           </div>
         </div>
         <div class="row ">
              <div class="col-6 pt-2 text-center bg-light text-dark"style='border:solid 0.5px gray'>
           <h5>Actifs</h5> 
              </div>
              <div class="col-6 pt-2 text-center bg-light text-dark"style='border:solid 0.5px gray'>
           <h5> Passifs</h5> 
         ...
         <div class="row ">
           ...
           <h5>Elements</h5> 
              ...
              <div class="col-2 pt-2 text-center bg-light text-dark"style='border:solid 0.5px gray'>
            <h5>Montants</h5>
              </div>
              <div class="col-4 pt-2 text-center bg-light text-dark"style='border:solid 0.5px gray'>
           <h5> Elements</h5> 
