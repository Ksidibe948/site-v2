...
<?php
   ...
   FROM    vente_materiels,clients WHERE    vente_materiels.id_client=clients.id AND  vente_materiels. id_entreprise=? ORDER BY id DESC");
  $vtm_materiels->execute(array($_SESSION['id']));
