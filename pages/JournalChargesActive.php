...
<?php
   ...
   $select_produitsexceptionnel=$bdd->prepare('SELECT id,id_entreprise,nom_operation,montant_th,taux_tva, 
     DATE_FORMAT(date,"%d/%m/%Y à %Hh%imin%ss") AS date, montant_payer
...
<div class="row">
 ...
 Charges Activés
        ...
        <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link  mb-1 shadow-sm bg-light   " href="visteurs.php?page=JournalChargesExploitations&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<?php
$MontantTva=$resultat['montant_th']*$resultat['taux_tva']/100;
$NetAPayer=$MontantTva+$resultat['montant_th'];
$reste=$NetAPayer-$resultat['montant_payer'];
?>     
     <div class="row mb-4">
      <div class="col-lg-12">
        ...
        <?= $resultat['date'] ?>
         ...
         <div class="row ml-2 mr-2">
           <div class="col-lg-12 text-center text-secondary">
            <h1> Journal  de <?= $resultat['nom_operation'] ?></h1>
           </div>
           </div>
           <hr>
         <div class="row ml-2 mr-2 ">
           <div class="col-lg-12">
             <div class="row">
               ...
               <div class="col-4 text-left"style='border:solid black 0.5px'>
                 <h6>Operation  (<?= $resultat['nom_operation'] ?>) </h6>
               </div>
               <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
               <h6><?=  $resultat['montant_th'] ?></h6>
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               ...
               <div class="col-4 text-left"style='border:solid black 0.5px'>
                 <h6> TVA Recupérable sur l'Operation <?= $resultat['nom_operation'] ?></h6>
               </div>
               <div class="col-2 col-xl-2  left" style='border:solid black 0.5px'>
               <h6><?=  $MontantTva?></h6>
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               ...
               <h6>Banque (Montant Payer)</h6>
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               <h6><?= $resultat['montant_payer'] ?></h6>
               </div>
               </div>
               <?php
                if ($reste>0) {
               ...
               <div class="col-4 text-right"style='border:solid black 0.5px'>
                 <h6>Reste à Payer Sur L'opération  <?=$resultat ['nom_operation']  ?></h6>
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               ...
               <div class="col-4 text-text-right"style='border:solid black 0.5px'>
                 <h6>Reste à Recupérer Sur L'Opération de <?=$resultat ['nom_operation']  ?></h6>
               </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               ...
               ?>
               <div class="row">
               <div class="col-8 col-xl-8  text-right" style='border:solid black 0.5px'>
                 <h6>Total</h6>
                 </div>
               <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
               <h6><?=
    ...
    <div class="row mt-4">
      ...
      <hr><div class="row">
        ...
        <?= $resultat['date'] ?>
         ...
         <div class="row ml-2 mr-2">
           <div class="col-lg-12 text-center text-secondary">
            <h1> Transfert de Charge de <?= $resultat['nom_operation'] ?></h1>
           </div>
           </div>
           <hr>
         <div class="row ml-2 mr-2 ">
           <div class="col-lg-12">
             <div class="row">
               ...
               <div class="col-4 text-left"style='border:solid black 0.5px'>
                 <h6>Immobilisation en Non Valeur </h6>
               </div>
               <div class="col-2 col-xl-2  text-left" style='border:solid black 0.5px'>
               <h6><?=  $resultat['montant_th'] ?></h6>
               </div>
               ...
               <div class="col-4 text-right"style='border:solid black 0.5px'>
                 <h6> Transfert de Charge de  <?= $resultat['nom_operation'] ?></h6>
               </div>
               <div class="col-2 col-xl-2  left" style='border:solid black 0.5px'>
