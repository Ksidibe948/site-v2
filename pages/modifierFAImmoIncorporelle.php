       ...
       ) 
       {
        $getid=$_GET['id'];
         ...
         $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET marchandise=? WHERE id=?');
          ...
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET reduction=? WHERE id=?');
          $req->execute(array($reduction,$getid));
          header('Location:index.php?page=DetailAchatImmoIcorporelle&id='.$_GET['id']);
          
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET taux_reduction=? WHERE id=?');
          $req->execute(array($taux_reduction,$getid));
          header('Location:index.php?page=DetailAchatImmoIcorporelle&id='.$_GET['id']);
                       
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET taux_exompte=? WHERE id=?');
          $req->execute(array($taux_exompte,$getid));
          header('Location:index.php?page=DetailAchatImmoIcorporelle&id='.$_GET['id']);
          
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET montant_transport=? WHERE id=?');
          ...
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET montant_emballage=? WHERE id=?');
          $req->execute(array($montant_emballage,$getid));
          header('Location:index.php?page=DetailAchatImmoIcorporelle&id='.$_GET['id']);
         
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET frais_accessoire=? WHERE id=?');
          $req->execute(array($frais_accessoire,$getid));
          header('Location:index.php?page=DetailAchatImmoIcorporelle&id='.$_GET['id']);
                                         
          $req=$bdd->prepare('UPDATE    AchatsImmoIncorporelle SET montant_avance=? WHERE id=?');
...
<?php
  ...
  <?php
   ...
   <div class="col-lg-12 mt-2 col-12">
                            ...
                            <div class="card-body">
                                <h1 class="text-center bg-secondary text-light  mb-5 p-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-1 col-form-label"> <h5>Fournisseur :</h5>  </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Marchandise:</h5> </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Quantité: </h5> </label>
                              <div class="col-sm-2">
                              <input type="number" value='<?= $donnees['quantite'] ?>'  name='quantite'class=" form-control" id="inputCity " required placeholder="EX: 10 pièces">
                              </div>
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Prix: </h5> </label>
                              <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Réductions: </h5> </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Taux: </h5> </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Exompte: </h5> </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Transport :</h5>  </label>
                              <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>TVA : </h5> </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Emballage :</h5>  </label>
                              <div class="col-sm-2">
                              ...
                              <label for="inputPassword" class="col-sm-1 col-form-label"><h5>Avance :</h5>  </label>
                              <div class="col-sm-2">
                              <input type="number" value='<?= $donnees['montant_avance'] ?>'  name='montant_avance'class="form-control" id="inputCity "  placeholder="  Ex: 100 ">
                              </div>
                              
                              <div class="col-lg-2 text-center"> <input type="submit" class='bg-success text-white' value="Valider"></div>
