...
?>
<?php
 $req=$bdd->prepare('SELECT * FROM stocksimmocorporelle WHERE id=?');
 $req->execute(array($getid));
 $reponse=$req->fetch();
...
?>
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        $ventes = $bdd->prepare('UPDATE stocksimmocorporelle set quantiteS=quantiteS - ? where id= ? ');
        $ventes->execute(array($quantite, $_GET['id']));
      
      $insert=$bdd->prepare('INSERT INTO CessionImmoCorporelle
      (
        id_client,
        id_entreprise,
        marchandise,
    ...
    header('Location:visteurs.php?page=CessionImmoCorporelle&id='.$getid);
...
<div class="row">
   ...
   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    Factures
     ...
     <a  class="nav-link  p-3  mb-1 shadow-sm bg-light "  style="font-size:1.2rem;" href="visteurs.php?page=Cessions&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
...
Cessions Immobilisations Corporelles
 ...
 <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="col-lg-6 col-12">  
                            ...
                            <div class="card shadow-lg text-secondary w-100 bg-light" style="width: 18rem; ">
                            <div class="card-body">
                            <h1 class="card-title mb-3 p-4 text-light bg-secondary text-center">
                                Cession  de <?= $reponse['marchandiseS']?>
                                </h1>
                                <form action="" method="POST" enctype="multipart/form-data">
                              <div class="form-group row">
                              <label for="inputPassword" class="col-sm-2 col-form-label"> <h6>Clients: </h6> </label>
                              <div class="col-sm-3">
