...
<?php
   ...
   FROM AchatsImmoIncorporelle,fournisseurs WHERE AchatsImmoIncorporelle.id_client=fournisseurs.id AND AchatsImmoIncorporelle. id_entreprise=? ORDER BY id DESC");
...
<?php
  ...
  Achats Immobilisations Incoorporelles
   ...
   <a style='font-size:1.2rem' class="nav-link text-success p-3  mb-1 shadow-sm bg-light "  href="visteurs.php?page=nouvellefactureachatimmoincorporelle&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          ...
          <h1>La liste de Factures Achats Immobilisations Corporelles</h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="visteurs.php?page=DetailAchatImmoIcorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
