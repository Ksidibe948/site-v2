...
<?php
  ...
  Achats Immobilisations Incoorporelles
   ...
   <a style='font-size:1.2rem' class="nav-link text-success p-3  mb-1 shadow-sm bg-light "  href="index.php?page=nouvellefactureachatimmoincorporelle&id=<?=$_SESSION['id'] ?>">
