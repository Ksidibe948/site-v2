...
<?php
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         <li class="nav-item ">
         <a  class="nav-link text-center"     href="index.php?page=nouvellefactureachatimmoincorporelle&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="card pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          ...
          <h1>La liste de Factures Achats Immobilisations Incorporelles</h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="index.php?page=DetailAchatImmoIcorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
