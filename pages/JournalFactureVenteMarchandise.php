...
<?php
   ...
   FROM   ventes,clients WHERE   ventes.id_client=clients.id AND   ventes. id=? ORDER BY id DESC");
  $ventes_marchandise->execute(array($_GET['id']));
   $compte= $ventes_marchandise->rowcount();
   $donnees= $ventes_marchandise->fetch()
 ?>
...
<div class="row">
   ...
   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    Factures de Ventes Marchandises
     ...
     <a style="font-size:1.2rem; color:orange; font-family:arial" class="nav-link  p-3  mb-1 shadow-sm bg-light " href="visteurs.php?page=JournalFactureVenteMarchandise&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="col-lg-12">
                ...
                ?>
                  ...
                  <div class="col-4 text-right"style='border:solid black 0.5px'>
                    <h6>Vente de  <?= $donnees['marchandise'] ?></h6>
                  </div>
                  <div class="col-2 col-xl-2  text-right" style='border:solid black 0.5px'>
