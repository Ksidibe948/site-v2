...
<div class="row">
     ...
     <div class="overflow-auto" style='width:72%;
       height:800px;'>
        ...
        <a  class="nav-link  p-3  mb-1 shadow-sm bg-light  bg-light " style="font-size:1.3rem; color:#A41FDE " href="index.php?page=comptabilité_generale&id=<?=$_SESSION['id'] ?>">
    ...
    <a style="font-size:1.3rem; " class="nav-link p-3  mb-1 shadow-sm bg-light bg-light text-secondary bg-light " href="index.php?page=banque&id=<?=$_SESSION['id'] ?>">
   ...
   <div class="row ">
    <div class="col-lg-3 mt-3 ">
        ...
        <a  class="nav-link bg-light text-secondary" href="index.php?page=banque&id=<?=$_SESSION['id'] ?>">
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card p-3 w-100 shadow-lg  bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary " href="index.php?page=capital&id=<?=$_SESSION['id'] ?>">
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link  bg-light text-secondary " href="index.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card p-3 w-100  shadow-lg bg-light"  >  
        <div class="card-title text-center ">
        <a  class="nav-link bg-light bg-light text-secondary "  href="index.php?page=clients&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center ">
        <a  class="nav-link bg-light bg-light text-secondary "  href="index.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center ">
        <a  class="nav-link bg-light bg-light text-secondary "  href="index.php?page=factures&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light bg-light text-secondary"  href="index.php?page=produits&id=<?=$_SESSION['id'] ?>"> 
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary"  href="index.php?page=charges&id=<?=$_SESSION['id'] ?>"> 
       ...
       <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary "  href="index.php?page=Stocks&id=<?=$_SESSION['id'] ?>"> 
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary"  href="index.php?page=balance&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary " href="index.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="col-lg-3 mt-3  ">
        <div class="card p-3 w-100 shadow-lg bg-light"  >
        <div class="card-title text-center ">
        <a  class="nav-link bg-light text-secondary"  href="index.php?page=cpc&id=<?=$_SESSION['id'] ?>"> 
