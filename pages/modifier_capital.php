...
<?php
           if (
             isset($_POST['capital'])
             AND isset($_POST["nombre_d'action"])
          ...
          
       {
             ...
             header('Location:visteurs.php?page=capital&id='.$_SESSION['id']);
...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   ...
   ?>
        ...
        if (isset($_GET['id'])) {
          $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
          $capi=$bdd->prepare('SELECT * FROM capitals where id=? ORDER BY id DESC');
          $capi->execute(array( $_GET['id']));
        }
...
<div class="row">
   ...
   <a   class="nav-link p-3  mb-1 shadow-sm bg-light bg-light  bg-light " style="font-size:1.3rem;color:#A41FDE" href="visteurs.php?page=capital&id=<?=$_SESSION['id'] ?>">
   ...
   <a  class="nav-link  text-success p-3  mb-1 shadow-sm bg-light bg-light "  style='margin-left:15px ;' href="visteurs.php?page=modifier_capital&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
  </svg> Modification du  capital </a>
...
>
                            ...
                            <div class="card-body">
                                <h5 class="card-title p-4 text-light bg-secondary  text-center">
                               <h1> Modifier Capital</h1> <hr>
                              
                                <form action="" method="POST" enctype="multipart/form-data">

                            <div class="form-group row">
                              
                              <label for="inputPassword" class="col-12 col-form-label"><h5>Montant du Capital</h5> </label>
                              <div class="col-12">
                              <input type="number" value='<?= $donnees['capital'] ?>'  name='capital'class="form-control" id="inputCity "  placeholder="  Ex: 1000000 ">
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="inputPassword" class="col-12 col-form-label"><h5>Nombre d'action</h5> </label>
                              <div class="col-12">
                              <input type="number" value='<?= $donnees['actions'] ?>'   name="nombre_d'action"   class="form-control" id="inputCity "  placeholder="  Ex: 100 ">
                              </div>
                            </div>
