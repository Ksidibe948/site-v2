...
<div class="row">
   ...
   <a   class="nav-link p-3  mb-1 shadow-sm bg-light bg-light  bg-light " style="font-size:1.3rem;color:#A41FDE" href="index.php?page=capital&id=<?=$_SESSION['id'] ?>">
   ...
   <a  class="nav-link  text-success p-3  mb-1 shadow-sm bg-light bg-light "  style='margin-left:15px ;' href="index.php?page=modifier_capital&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
