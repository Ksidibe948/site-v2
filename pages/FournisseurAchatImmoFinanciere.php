...
<?php
   ...
   FROM AchatsImmoFinanciere,fournisseurs WHERE AchatsImmoFinanciere.id_fournisseur=fournisseurs.id AND   AchatsImmoFinanciere.id_fournisseur=? ORDER BY id DESC");
...
<div class="row">
 ...
 <?php
  ...
  <h5> vous n'avez pas encore payé une immobilisation Financière  chez <?=$resultat['nom']?></h5>
