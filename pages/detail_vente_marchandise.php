...
<div class="row">
 ...
 <a style=' font-size:1.1rem;;' class="nav-link text-success p-3  mb-1 shadow-sm bg-light  " href="index.php?page=modifier_facture_vente_marchandise&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a style='font-size:1.1rem;; ' class="nav-link p-3  mb-1 shadow-sm bg-light   text-danger " href="index.php?page=supprimer_facture_vente_marchandise&id=<?=$donnees['id'] ?>&id_entreprise=<?=$_SESSION['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
