...
<?php
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         <li class="nav-item ">
         <a  class="nav-link text-center"     href="index.php?page=nouvellefactureachatimmocorporelle&id=<?=$_SESSION['id'] ?>">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="index.php?page=DetailAchatImmoCorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
