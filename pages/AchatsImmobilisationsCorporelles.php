...
<?php
   ...
   FROM AchatsImmoCorporelle,fournisseurs WHERE AchatsImmoCorporelle.id_client=fournisseurs.id AND AchatsImmoCorporelle. id_entreprise=? ORDER BY id DESC");
...
<div class="row">
  ...
  Achats Immobilisations Corporelles
   ...
   <a style='font-size:1.2rem' class="nav-link text-success   p-3  mb-1 shadow-sm bg-light"  href="visteurs.php?page=nouvellefactureachatimmocorporelle&id=<?=$_SESSION['id'] ?>">
 ...
 <?php
    ...
    {
        ?>
        <a class="link text-dark "  href="visteurs.php?page=DetailAchatImmoCorporelle&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
