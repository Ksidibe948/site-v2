  ...
  Cessions Immobilisations Financières
   ...
   <div class="row ">
    <div class="col-lg-12 mt-3 ">
        ...
        <a  class="nav-link text-white" href="index.php?page=ListeAchatImmoFinanciere&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'> Enrgistre une cession immobilisation Incorporelle</p>
