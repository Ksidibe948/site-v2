...
<?php
       ...
       {   
        ...
        systeme,duree,mois)
             ...
             header('Location:index.php?page=ChargesActive&id='.$_SESSION['id']);
      }                 
         ?>
...
<div class="row">
 ...
 <a style='font-size:1.2rem' class="nav-link text-info mb-1 shadow-sm bg-light   "  href="index.php?page=nouveauchargesActive&id=<?=$_SESSION['id'] ?>">
