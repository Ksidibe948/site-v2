...
?>
<?php
 $req=$bdd->prepare('SELECT * FROM stocksimmofinanciere WHERE id=?');
 $req->execute(array($getid));
 $reponse=$req->fetch();
...
?>
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        $ventes = $bdd->prepare('UPDATE stocksimmofinanciere set quantiteS=quantiteS - ? where id= ? ');
        $ventes->execute(array($quantite, $_GET['id']));
      
      $insert=$bdd->prepare('INSERT INTO CessionImmoFinanciere
      (
        id_client,
        id_entreprise,
        marchandise,
    ...
    header('Location:index.php?page=CessionImmoFinanciere&id='.$getid);
...
<div class="row">
 ...
 <a style='font-size:1.3rem' class="nav-link p-3  mb-1 shadow-sm bg-light text-info "  href="index.php?page=ListeAchatImmoFinanciere&id=<?=$_SESSION['id'] ?>">
  <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="col-lg-6 col-11">  
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-2 col-form-label"><h5>TVA  : </h5> </label>
                              <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-2 col-form-label"><h5>Numéro Banque  : </h5> </label>
                              <div class="col-sm-3">
