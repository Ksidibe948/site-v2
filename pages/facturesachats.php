  ...
  <?php
   ...
   <div class="row  mt-2 ">
    <div class="col-lg-4 col-6 ">
        <div class="card text-center  w-100   bg-light  "  >  
     
        <a  class="nav-link  text-secondary pb-5  bg-light "  href="index.php?page=achats&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class=" col-lg-4 col-6 ">
        <div class="card text-center  w-100   bg-light   mb-2"  >
     
        <a  class="nav-link text-secondary pb-5  bg-light"  href="index.php?page=achat_immobilisation&id=<?=$_SESSION['id'] ?>"> 
  <p style='  font-size:1.5rem'>Achats <br> Immobilisations</p><hr>
          <svg width="5em"  color="#A41FDE" height="5em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
    ...
    <div class=" col-lg-4 col-6  ">
        ...
        <a  class="nav-link text-secondary pb-5 bg-light" href="index.php?page=factureachatmatiere_premiere&id=<?=$_SESSION['id'] ?>"> 
  <p style='  font-size:1.5rem'>Achats <br> Matières premières</p><hr>
          <svg width="5em"  color="#A41FDE" height="5em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
