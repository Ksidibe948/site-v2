...
<div class="row">
   ...
   <div class="row ">
    <div class="col-lg-4 ">
        ...
        <a  class="nav-link text-secondary bg-light "  href="index.php?page=achats&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-4  ">
        <div class="card w-100  shadow-lg bg-light pb-5  mb-2"  >
        <div class="card-title text-center ">
        <a  class="nav-link text-secondary bg-light"  href="index.php?page=achat_immobilisation&id=<?=$_SESSION['id'] ?>"> 
