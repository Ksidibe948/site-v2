...
<?php
 ...
 <?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
    ...
    FROM PayementAchatMatierePremiere  where  id_client=? ORDER BY id DESC');
  ...
  <div class="col-12">
     <?php
       ...
       <div class="row mb-2">
         ...
         <div class="card w-100  pb-5 p-2 bg-white" >
            <div class="row">
...
<div class="row mt-4">
         <div class="col-lg-12">
         <div class="card w-100  p-2 pb-5 bg-white" >
            <div class="row">
             <div class="col-lg-12 text-center ">
             <?="<img src='".$_SESSION['images']."' class='images' style='width:5rem ; height:5rem;  ' alt=''>" ;?><br>
            <?= $donnees['nom'] ?><br>
  ...
  ?>
   ...
   if ($donnees['net_a_payer']>0) {
         ...
         <div class="card w-100  p-3 pb-5 bg-white" >
            <div class="row">
             <div class="col-lg-12 text-center ">
             <?="<img src='".$_SESSION['images']."' class='images' style='width:5rem ; height:5rem;  ' alt=''>" ;?><br>
            <?= $donnees['nom'] ?><br>
