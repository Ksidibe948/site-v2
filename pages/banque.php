...
<div class="row">
   ...
   <div class="col-lg-6 col-12">    
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a style='font-size:1.1rem' class="nav-link text-light " href="visteurs.php?page=nouvelle_banque&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Créer un nouveau compte Bancaire</p>
        <svg width="10em" height="10em"  viewBox="0 0 16 16" class="bi  bi-credit-card-2-back" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M14 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
        <path d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zM1 9h14v2H1V9z"/>
       </svg>
       </a> 
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ?>
            <div class="col-6 ">
             <div class="card w-100 shadow-lg mb-2 bg-light  p-2 " >
             <a class="nav-link text-secondary bg-light" href="visteurs.php?page=detail_banque&id=<?=$resultat['id'] ?>">
                <div class='imagess'>
                <?="<img src='".$resultat['photo']."' class='card-img' ' alt=''>" ;?>
             </div>
             </a>
            </div>
            </div>
