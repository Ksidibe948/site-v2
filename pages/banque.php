...
<div class="row">
   ...
   <div class="col-lg-6 col-12">    
    ...
    <div class="col-lg-12 mt-3 ">
        ...
        <a style='font-size:1.1rem' class="nav-link text-light " href="index.php?page=nouvelle_banque&id=<?=$_SESSION['id'] ?>">
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ...
            <div class="col-6 ">
             ...
             <a class="nav-link text-secondary bg-light" href="index.php?page=detail_banque&id=<?=$resultat['id'] ?>">
                <div class='imagess'>
