...
<?php
  ...
  Achats Immobilisations Financières 
   ...
   <a style='font-size:1.2rem' class="nav-link text-success p-3  mb-1 shadow-sm bg-light "  href="visteurs.php?page=nouvellefactureachatimmoFinancierse&id=<?=$_SESSION['id'] ?>">
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 pt-2 text-center bg-secondary  text-light"style='border:solid 0.5px gray'>
          <h1>La liste de Factures Achats immobilisations Financières</h1>
        </div>
          </div> 
   <div class="row ">
 ...
 <?php
    while($resultat=  $achamarchandises->fetch())
    {
        ?>
        <a class="link text-dark "  href="visteurs.php?page=DetailAchatImmoFinanciere&id=<?=$resultat['id'] ?>" style='text-decoration:none'>
          <div class="row  ">
