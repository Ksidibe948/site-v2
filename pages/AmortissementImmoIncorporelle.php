...
if (isset($_GET['id'])) {
   ...
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $amortissemnt_immoCoporelle=$bdd->prepare("SELECT * FROM AmortissementImmoincorporelle
    ...
    <div class="row">
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         <li class="nav-item ">
          <a  style="font-size:1.2rem;" class="nav-link  p-3    text-danger"  href="index.php?page=SupprimerImmoincorporelle&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="row">
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         <li class="nav-item ">
         <a  class="nav-link text-primary "  href="index.php?page=AmortissementImmoINCoporelle&id=<?=$_GET['id'] ?>">              
