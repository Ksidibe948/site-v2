...
<?php
  ...
  $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  $select=$bdd->query('SELECT* FROM achats');
...
?>
 ...
 <?php 
       ...
       if (isset($_POST['marchandise'])
        ...
        $stokks_marchandises=$bdd->prepare('INSERT INTO stocks_matierepremiere
        ...
        $insert=$bdd->prepare('INSERT INTO achats_matierepremiere
      (
        id_fournisseur,
        id_entreprise,
        marchandise,
    ...
    header('Location:visteurs.php?page=factureachatmatiere_premiere&id='.$_SESSION['id']);
...
<div class="row">
  ...
  <div class="col-12">
                            ...
                            <div class="card-body">
                                <h1 class="card-title text-light p-4 bg-secondary text-center">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-sm-2 col-form-label"><h6>Quantite</h6></label>
                              <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                              <select id="inputState" value='<?= $donnees['reduction'] ?>' name="reduction" class="form-control ">
