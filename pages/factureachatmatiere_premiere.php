...
?>
   ...
   $verification= $matierepremiere->rowcount();
...
<?php
  ...
  <?php
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-white">
     ...
     <nav class="navbar sticky-top navbar-expand-lg navbar-light ">
        <ul  class="navbar-nav  mr-auto ">
         <li class="nav-item ">
         <a  class="nav-link text-center"     href="index.php?page=nouvelleachatmateriere_premiere&id=<?=$_SESSION['id'] ?>">
        ...
        </svg> <h5>Une Nouvelle Facture</h5>
        </a> 
   </li>
   </ul>
   </div>
   ...
   <div class="col-lg-6 pl-4 pr-4  col-12">
    ...
    <?php
       if ( $verification>0) {
            ?>      
  <div class="col-12">
  <div class="card mt-2 pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
...
Vous n'avez pas encore effectuer une operation d'achat matière!   <strong>Cliquer sur le icone pour enregistre une facture </strong> 
