...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $select_produitsexceptionnel=$bdd->prepare('SELECT id,id_entreprise,nom_operation,montant_th,taux_tva, 
     DATE_FORMAT(date,"%d/%m/%Y à %Hh%imin%ss") AS date
    FROM  chargeACtive where id=?  ORDER BY id DESC');
...
<div class="row">
  ...
  <a  class="nav-link mb-1 shadow-sm bg-light "  style="font-size:1.2rem;color:#A41FDE" href="visteurs.php?page=ChargesActive&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen-exit" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M5.5 0a.5.5 0 0 1 .5.5v4A1.5 1.5 0 0 1 4.5 6h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5zm5 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 10 4.5v-4a.5.5 0 0 1 .5-.5zM0 10.5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 6 11.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zm10 1a1.5 1.5 0 0 1 1.5-1.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4z"/>
  </svg>
 Charges Activés
        </a>
        <a style="font-size:1.2rem; color:orange; font-family:arial" class="mb-1 shadow-sm bg-light nav-link  " href="visteurs.php?page=JournalChargesActive&id=<?=$_GET['id'] ?>"><svg width="1em" height="1.5em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg> Journal de  <?=$resultat['nom_operation'] ?>  </a>
    
<a style="font-size:1.2rem; color:red; font-family:arial" class="nav-link mb-1 shadow-sm bg-light " href="visteurs.php?page=AmortissementAmortissementNonValeur&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-graph-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0zm10 11.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-1 0v2.6l-3.613-4.417a.5.5 0 0 0-.74-.037L7.06 8.233 3.404 3.206a.5.5 0 0 0-.808.588l4 5.5a.5.5 0 0 0 .758.06l2.609-2.61L13.445 11H10.5a.5.5 0 0 0-.5.5z"/>
</svg> Amortissement  de  <?=$resultat['nom_operation'] ?>  </a>
  
    <a style="font-size:1.2rem;" class="nav-link mb-1 shadow-sm bg-light text-success" href="visteurs.php?page=modifier_chargesActivite&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
  </svg> Modifier  <?=$resultat['nom_operation'] ?> </a>
  <a  style="font-size:1.2rem;" class="nav-link mb-1 shadow-sm bg-light text-danger" href="visteurs.php?page=supprimerChargeActive&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
 </svg> Supprimer 
  <?=$resultat['nom_operation'] ?> </a> 
 </a>
   ...
   <div class="row ">
          <div class="col-3 pt-2 text-center text-light bg-secondary"style='border:solid 0.5px gray'>
          <h5>date</h5>
          </div>
          <div class="col-3 pt-2 text-center text-light bg-secondary"style='border:solid 0.5px gray'>
          <h5>Nom d'opération</h5>
          </div>
          <div class="col-2 pt-2 text-center text-light bg-secondary"style='border:solid 0.5px gray'>
           <h5>Montant ht</h5>
          </div>
          <div class="col-2 pt-2  text-center text-light bg-secondary"style='border:solid 0.5px gray'>
           <h5>TVA</h5>
        ...
        <div class="row ">
          <div class="col-3 pt-2 text-left"style='border:solid 0.5px gray'>
          <h5><?=$resultat['date'] ?></h5>
          </div>
          <div class="col-3 pt-2 text-left"style='border:solid 0.5px gray'>
          <h5><?=$resultat['nom_operation'] ?></h5>
          </div>
          <div class="col-2 pt-2 text-right"style='border:solid 0.5px gray'>
           <h5><?=$resultat['montant_th'] ?></h5>
          </div>
          <div class="col-2 pt-2 text-right"style='border:solid 0.5px gray'>
           <h5><?php
         echo $resultat['montant_th']* $resultat['taux_tva'] /100?></h5>
          </div>
          <div class="col-2 pt-2 text-right"style='border:solid 0.5px gray'>
           <h5><?php
         echo $resultat['montant_th']* $resultat['taux_tva'] /100 +$resultat['montant_th']?></h5>
          </div>
          </div>
