...
<!-- la partie inscription -->
                            ...
                            <div class="col-lg-12 ">
                            <div class="card  text-dark pb-5 bg-light  w-100" style="width: 18rem; ">
                            <div class="card-body">
                               <h1><div class="text-center pb-3">Créer un nouveau compte bancaire</div></h1>
                            ...
                            <div class="col-2"></div>
                              ...
                              <input type="file"  class="form-control" id="inputCity " name='monfichier'  class="form-control mr-5" id="inputCity" >
                              </div> 
                              </div>
                              <div class="form-group row">
                              <div class="col-2"></div>
