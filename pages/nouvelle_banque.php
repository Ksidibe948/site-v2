          ...
          
                                {
                                        ...
                                        if ($_FILES['monfichier']['size'] <= 1000000)
                                        {
                                                ...
                                                if (in_array($extension_upload, $extensions_autorisees))
                                                {
                                                       ...
                                                       echo $image='images/' . $_FILES['monfichier']['name'];
                                                       echo $nom_banque=$_POST["nom_banque"];
                                                        ...
                                                        banque(id_entreprise,nom_banque,adresse,numero,email,photo,montant,frais, taux_tva)
                                                        VALUES(?,?,?,?,?,?,?,?,?)
                                                         ");
                                                        $insert->execute(array( $_SESSION['id'],$nom_banque,$adresse,$numero, $email,$image,  $montant, $frais,$taux_tva));
                                                       
                                                        header('Location:visteurs.php?page=banque&id='.$_SESSION['id']);
...
<div class="row">
   ...
   <div class="col-lg-6 col-12">
                            ...
                            <div class="col-lg-10">
                            <div class="card shadow-lg  text-secondary bg-light w-100" style="width: 18rem; ">
                            <div class="card-body">
                                <h1 class="card-title text-light p-3 bg-secondary  text-center">
                              ...
                              <div class="col-lg-6">
                              <input type="text"  name='nom_banque'class="form-control" id="inputCity " required placeholder="  Ex: BMC ">
                              </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                              <input type="text"  name='adresse'class="form-control" id="inputCity " required  placeholder="  Ex: BMC ">
                              </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                              <input type="number"  name='numero' class="form-control" id="inputCity" required placeholder="  Ex:+212 0640637157 ">
                              </div> 
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                            <input type="text"  name='email' class="form-control" id="inputCity"  placeholder="  Ex:bmc@gmail.com">
                            </div> 
                          </div>
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                              <input type="file" class="form-control" id="inputCity " name='monfichier' required class="form-control mr-5" id="inputCity" >
                              </div> 
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                              <input type="number"  name='montant' class="form-control" id="inputCity " required placeholder="  Ex: 1000000 ">
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                              <input type="number"  name="frais"   class="form-control" id="inputCity "  placeholder="  Ex: 100 ">
                              </div>
                            </div>
