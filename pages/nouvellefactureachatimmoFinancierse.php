...
?>
 ...
 <?php 
       ...
       ) 
       {
        ...
        $stokks_marchandises=$bdd->prepare('INSERT INTO StocksimmoFinanciere
        (id_fournisseurS,
        id_entrepriseS,
        marchandiseS,
        quantiteS,
        ...
        taux_tvaS,
        frais_accessoireS,
        monyen_payementS,montant_payementS) VALUES(  ?,?,?,?,?, ?,?,?,?)');
        $stokks_marchandises->execute(array($numero_client,$_SESSION['id'],$marchandise,$quantite,$prix,
        $taux_tva, $frais_accessoire,
        ...
        $insert=$bdd->prepare('INSERT INTO AchatsImmoFinanciere
      (
        id_fournisseur,
        id_entreprise,
        marchandise,
    ...
    header('Location:visteurs.php?page=AchatsImmobilisationsFinancières&id='.$_SESSION['id']);
  ...
  Achats Immobilisations Financières 
   ...
   <a style='font-size:1.2rem' class="nav-link text-success p-3  mb-1 shadow-sm bg-light "  href="visteurs.php?page=nouvellefactureachatimmoFinancierse&id=<?=$_SESSION['id'] ?>">
     ...
     <div class="col-lg-6 col-12">    
                            ...
                            <div class="card-body">
                                <h1 class="card-title text-center p-4 text-light bg-secondary">
