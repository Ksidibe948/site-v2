...
<?php
       ...
       {   
            ...
            $modifications = $bdd->prepare("update somme_charges set montant = montant +  ? where id_entreprise = ? ");
            $modifications->execute(array(  $montant_th,$_SESSION['id']));
            
            $inserts=$bdd->prepare("INSERT INTO 
            somme_charges(id_entreprise,montant)
            VALUES(?,?)
             ");
                $inserts->execute(array( $_SESSION['id'], $montant_th));
           
             $insert=$bdd->prepare("INSERT INTO 
             autres_charges(id_entreprise,nom_operation,montant_th, taux_tva,numero_banque,montant_payer)
             VALUES(?,?,?,?,?,?)
              ");
             $insert->execute(array( $_SESSION['id'],$nom_operation,  $montant_th,$taux_tva, $numero_banque, $montant_payer));
             header('Location:index.php?page=autres_charges&id='.$_SESSION['id']);
...
<body>
    <div class="banner-area">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="index.php?page=autres_charges">Autre Charges<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active  mr-3">
              <a class="nav-link" href="">Nouvelle Charge<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3">
            ...
            <a class="nav-link text-white text-center" href="index.php?page=publication&id=<?=$_SESSION['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi mr-1 bi-brightness-high" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="nav-link text-white text-center" href="index.php?page=demande&id=<?=$_SESSION['id'] ?>"> 
        ...
        <a class="nav-link text-white text-center" href="index.php?page=modifier_utilisateurs&id=<?=$_SESSION['id'] ?>"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-gear-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="nav-link text-white text-center" href="index.php?page=deconnexion"> 
     ...
     <div class="container">
         <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                Enregistre une nouvelle sortie  d'argent
                                </h5><hr>
                                <form action="" method="POST" enctype="multipart/form-data">
                                
                              <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">Nom de l'operation</label>
                              <div class="col-lg-3">
                              <input type="text" required name='nom_operation'class="form-control" id="inputCity "  placeholder="  Ex: gain de change ">
                              </div>
                            </div><hr>
                            <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">Montant  HT</label>
                              <div class="col-lg-3">
                              <input type="number" required name='montant_th'class="form-control" id="inputCity "  placeholder="  Ex: 1000 ">
                              </div>
                            </div><hr>
                                 
                            <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">TVA </label>
                              <div class="col-lg-3">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">Numéro bancaire</label>
                              <div class="col-lg-3">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-2"></div>
                              <label for="inputPassword" class="col-lg-3 col-form-label">Montant payer</label>
                              <div class="col-lg-3">
                              <input type="number"  required  name='montant_payer'class="form-control" id="inputCity "  placeholder="  Ex: 100 ">
                              </div>
                            </div><hr>

                                <div class="form-group">
                                    <input type="submit" class='bg-success text-white' value="Confirmer" style='margin-left:380px'>
                                </div>
                                </form>
                            </div>
                            </div>
