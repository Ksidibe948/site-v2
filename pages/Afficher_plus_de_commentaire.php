    ...
    <ul class="navbar-nav ">
      ...
      <ul class="navbar-nav ">
            ...
            <div class="dropdown-menu  mega-area" aria-labelledby="navbarDropdown">
              <a class="dropdown-item " href="index.php?page=comptabilite&id=<?=$_SESSION['id'] ?>">Comptabilité</a>
            ...
            <a class="nav-link text-dark pl-5 " href="index.php?page=publication&id=<?=$_SESSION['id'] ?>">Publier</a>
                <a class="dropdown-item  text-dark pl-5" href="#">SMS</a>
            <a class="nav-link  text-dark pl-5 " href="index.php?page=demande&id=<?=$_SESSION['id'] ?>"> 
            Demande</a>
            </div>
            </div>
        <div class="dropdown">
        ...
        <a class="nav-link text-dark pl-3" href="index.php?page=modifier_utilisateurs&id=<?=$_SESSION['id'] ?>"> Modifier Votre profil</a>
            <div class="dropdown-divider"></div>
            <a class="nav-link text-dark pl-5" href="index.php?page=deconnexion"> 
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
     <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item pl-5 ">
       ...
       <a class="nav-link " href="index.php?page=les_articles&id=<?=$_GET['id'] ?>"><i class="fas fa-globe-africa"></i> Articles</a>
      ...
      <div class="col-lg-8  ">
           ...
           <a class="nav-link text-dark  " href="index.php?page=autor&id=<?=$_SESSION['id'] ?>">
          ...
          <span class=''><?="<img src='".$reponses['images']."' class='coll ' style='width:1.5rem ; height:1.6rem; border-radius:100px ; '  alt=''>" ;?> </span>
           <?= $reponses['nom'] ?>
             ...
             <div class="col-lg-1 "></div>
               ...
               <a style='text-decoration: none; color:#A41FDE' href="index.php?page=action&t=1&id=<?=$_GET['id'] ?>"><svg width="1.5em"  height="1.5em" viewBox="0 0 16 16" color='#A41FDE' class="bi bi-hand-thumbs-up mb-2 mt-2  ml-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-lg-3 mr-2 bg-light  text-center">
               <a style='text-decoration: none; color:#A41FDE'  class='' href="index.php?page=action&t=2&id=<?=$_GET['id'] ?>"><svg width="1.5em" color='green' height="1.5em" viewBox="0 0 16 16" class="bi  bi-hand-thumbs-down mb-2 mt-2 ml-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
       ...
       <?php
        ...
        <div class="row">
          ...
          <div class="col-lg-12 bg-light text-center">
              <a style='color:#A41FDE'  class='pl-2 pb-2 ' href="index.php?page=Afficher_plus_de_commentaire&id=<?=$get?>">Afficher plus de commentaire</a>
              </div>
          </div>
