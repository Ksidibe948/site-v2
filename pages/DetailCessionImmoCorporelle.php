...
Cessions Immobilisations Corporelles
 ...
 <a style=' font-size:1.1rem;;' class="nav-link  p-3  mb-1 shadow-sm bg-light  text-success  " href="visteurs.php?page=ModifierFacatureCessionImmoCorporelle&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a style='font-size:1.1rem;; ' class="nav-link  p-3  mb-1 shadow-sm bg-light text-danger " href="visteurs.php?page=SupprimerFactureCessionImmoCorporelle&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<?php
       ...
       <div class="container">
        <div class="row mb-2">
         <div class="col-12">
          <div class="card shadow-lg mt-5 w-100">
