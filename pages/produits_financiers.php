...
Ajouter un nouveau produit Financier
  ...
  <div class="card shadow-lg pl-4 pb-5 pt-5 pr-4 w-100">
   <div class="row ">
          <div class="col-12 pt-2 text-center text-white  bg-secondary"style='border:solid 0.5px gray'>
          <h1>La Liste des produits Financier</h1>
        </div>
          </div> 
   <div class="row ">
          <div class="col-4 pt-2 "style='border:solid 0.5px gray'>
          <h5> Produits</h5>
          </div>
