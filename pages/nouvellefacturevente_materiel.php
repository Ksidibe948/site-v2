...
?>
 <?php 
    ...
    header('Location:visteurs.php?page=ventes_materiels&id='.$getid);
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Etablir une facture de vente <?= $reponse['marchandiseS'] ?>
  ...
  <a style='font-size:1.3rem' class="nav-link  text-info "  href="visteurs.php?page=Listes_des_vente_marchandise&id=<?=$_SESSION['id'] ?>">
